...
function afterFormDataLoadedFormIOForm(thisInstance){
	console.log("afterFormDataLoadedFormIOForm...");
	...
	thisInstance.components.AccountingTableCode.setValue("Copy-of-"+ thisInstance.components.AccountingTableCode.value);
