package com.sambaash.platform.portlet.calendar.util;
...
public class EventFreindlyURLMapper extends BaseFriendlyURLMapper{
	...
	private static Log _log = LogFactoryUtil.getLog(EventFreindlyURLMapper.class);
...
//        }
	...
	public void populateParams(String friendlyURLPath, Map<String, String[]> parameterMap,
        ...
        _log.debug("friendlyURLPath  "+friendlyURLPath);
       ...
       if (y == -1) {
        ...
        if(cmd.equals("view_event")){
            ...
            addParameter(parameterMap, "struts_action", "/calendar/view_event");
    ...
    private String getParameterValue(RenderRequest req, String key) {
        String paramValue = "";
