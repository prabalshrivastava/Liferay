...
import com.sambaash.platform.finance.ajax.StripeChargeActionHandler;
import com.sambaash.platform.finance.ajax.WalletAmountActionHandler;
import com.sambaash.platform.finance.ajax.WalletListActionHandler;
import com.sambaash.platform.finance.constants.FinanceConstants;

/**
 * Portlet implementation class CashierCounterPortlet
 */
public class MyWalletPortlet extends MVCPortlet {
	...
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("stripecharge", StripeChargeActionHandler.class);
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("walletamount", WalletAmountActionHandler.class);
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("walletlist", WalletListActionHandler.class);
	 ...
	 */
	private Log log = LogFactoryUtil.getLog(MyWalletPortlet.class.getName());
	...
	public void savePreferences(ActionRequest actionRequest, ActionResponse actionResponse) {
		...
		String receiptBaseUrl = ParamUtil.getString(actionRequest, FinanceConstants.PREF_RECEIPT_BASE_URL, "");
		String payOnlineBaseUrl = ParamUtil.getString(actionRequest, FinanceConstants.PREF_PAY_ONLINE_BASE_URL, "");
		try {
			...
			preferences.setValue(SystemSetupConstants.PREF_BASE_URL, baseUrl);
			preferences.setValue(FinanceConstants.PREF_RECEIPT_BASE_URL, receiptBaseUrl);
			preferences.setValue(FinanceConstants.PREF_PAY_ONLINE_BASE_URL, payOnlineBaseUrl);
			preferences.store();
