function challengesFileDragAndDrop() {
	...
	// initialize
	this.Init = function (dragDiv,fltable,paramName,ajaxurl,srcSelection,pns,action,afterFileUpload) {
				...
				AUI().use('aui-node','aui-base',function(A){
					...
					if(fileElmnt){
						fileElmnt.on('change',function(e){
							if(thisobj.paramName == 'challengeLogo'){
