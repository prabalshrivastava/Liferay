 ...
 * @generated
 */
public abstract class PECustomActionInfoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PECustomActionInfoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PECustomActionInfoLocalServiceUtil.getService());
		setClass(PECustomActionInfo.class);

		setClassLoader(com.sambaash.platform.srv.processbuilder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPEActionId");
	}
}