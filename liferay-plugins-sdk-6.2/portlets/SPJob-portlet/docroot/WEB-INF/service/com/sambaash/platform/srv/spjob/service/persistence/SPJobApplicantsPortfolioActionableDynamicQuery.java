 ...
 * @generated
 */
public abstract class SPJobApplicantsPortfolioActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPJobApplicantsPortfolioActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(SPJobApplicantsPortfolioLocalServiceUtil.getService());
		setClass(SPJobApplicantsPortfolio.class);

		setClassLoader(com.sambaash.platform.srv.spjob.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("primaryKey.jobApplyId");
	}
}