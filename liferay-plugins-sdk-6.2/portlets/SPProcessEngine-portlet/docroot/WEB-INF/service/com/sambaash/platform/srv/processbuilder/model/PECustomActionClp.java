 ...
 */
public class PECustomActionClp extends BaseModelImpl<PECustomAction>
	implements PECustomAction {
	public PECustomActionClp() {
	}
	...
	public void setUuid(String uuid) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				Class<?> clazz = _peCustomActionRemoteModel.getClass();

				Method method = clazz.getMethod("setUuid", String.class);

				method.invoke(_peCustomActionRemoteModel, uuid);
			}
			catch (Exception e) {
	...
	public void setSpPEActionId(long spPEActionId) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, spPEActionId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGroupId(long groupId) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, groupId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCompanyId(long companyId) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, companyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserName(String userName) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, userName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreateDate(Date createDate) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setActionClassName(String actionClassName) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, actionClassName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTitle(String title) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, title);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDefaultConfiguration(String defaultConfiguration) {
		...
		if (_peCustomActionRemoteModel != null) {
			try {
				...
				method.invoke(_peCustomActionRemoteModel, defaultConfiguration);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getPECustomActionRemoteModel() {
		return _peCustomActionRemoteModel;
	}

	public void setPECustomActionRemoteModel(
		BaseModel<?> peCustomActionRemoteModel) {
		_peCustomActionRemoteModel = peCustomActionRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _peCustomActionRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_peCustomActionRemoteModel,
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			PECustomActionLocalServiceUtil.addPECustomAction(this);
		}
		else {
			PECustomActionLocalServiceUtil.updatePECustomAction(this);
		}
	}

	@Override
	public PECustomAction toEscapedModel() {
		return (PECustomAction)ProxyUtil.newProxyInstance(PECustomAction.class.getClassLoader(),
			new Class[] { PECustomAction.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		PECustomActionClp clone = new PECustomActionClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PECustomActionClp)) {
			return false;
		}

		PECustomActionClp peCustomAction = (PECustomActionClp)obj;
	...
	private BaseModel<?> _peCustomActionRemoteModel;
