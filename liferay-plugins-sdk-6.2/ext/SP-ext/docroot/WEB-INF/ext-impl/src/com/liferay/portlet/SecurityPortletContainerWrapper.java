...
public class SecurityPortletContainerWrapper implements PortletContainer {
	...
	protected void processRenderException(
		...
		if (portlet.isShowPortletAccessDenied()) {
			...
			// Naresh, April 26, 2016 - While viewing private layout page, access denied msg displaying for chat portlet.
			// So hiding the message with below code. Should look for right approach to clear access error 
			if("1_WAR_SPChatportlet".equals(portlet.getPortletId())){
				portletContent = "/html/portal/blank.jsp";
			}
		}
