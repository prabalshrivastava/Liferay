 ...
 * @generated
 */
public abstract class SPAuditActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPAuditActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPAuditLocalServiceUtil.getService());
		setClass(SPAudit.class);

		setClassLoader(com.sambaash.platform.srv.spservices.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("SPAuditId");
	}
}