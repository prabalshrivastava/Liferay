...
package com.sambaash.platform.srv.sprating.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			AttrRateLocalServiceUtil.clearService();

			RatingAttrLocalServiceUtil.clearService();

			RatingComponentLocalServiceUtil.clearService();
		}
	}
}