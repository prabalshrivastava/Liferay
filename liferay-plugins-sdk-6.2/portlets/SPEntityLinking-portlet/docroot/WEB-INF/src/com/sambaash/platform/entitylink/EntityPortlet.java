package com.sambaash.platform.entitylink;
 ...
 */
public class EntityPortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(EntityPortlet.class.getName());
