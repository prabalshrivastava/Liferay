...
public abstract class BaseIndexer implements Indexer {
	...
	public Map<String, String> getIndexedFields() {
		...
		map.put(Field.COMMENTS, "Comments");
		map.put(Field.CONTENT, "Content");
		map.put(Field.DESCRIPTION, "Description");
		map.put(Field.TITLE, "Title");
		map.put(Field.USER_NAME, "User Name");
		map.put(Field.URL, "Url");
		map.put(Field.COMPANY_ID, "Company Id");
		map.put(Field.ENTRY_CLASS_NAME, "Entry Class Name");
		map.put(Field.ENTRY_CLASS_PK, "Entry Class PK");
		map.put(Field.FOLDER_ID, "Folder Id");
		map.put(Field.PORTLET_ID, "Portlet Id");
		map.put(Field.ROLE_ID, "Role Id");
		map.put(Field.SCOPE_GROUP_ID, "Group Id");
		map.put(Field.USER_ID, "User Id");
		map.put(Field.ASSET_TAG_IDS, "Tag Id");
		map.put(Field.ASSET_TAG_NAMES, "Tag Name");
		map.put(Field.CREATE_DATE, "Created Date");
		map.put(Field.MODIFIED_DATE, "Modified Date");
		map.put(Field.VIEW_COUNT, "View Count");
		map.put("visible", "Viewable");
		return map;
	}
