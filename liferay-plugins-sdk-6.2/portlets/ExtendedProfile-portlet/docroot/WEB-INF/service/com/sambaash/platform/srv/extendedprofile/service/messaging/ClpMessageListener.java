...
package com.sambaash.platform.srv.extendedprofile.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SPCertificationLocalServiceUtil.clearService();

			SPCompetencyLocalServiceUtil.clearService();

			SPJobRoleLocalServiceUtil.clearService();
		}
	}
}