										...
										<div class="col col-sm-4 has-error">
											...
											<div class="form-group formio-component-textfield">
												<input type="text" name="year" id="inp_year" onkeypress="handleEnter(event)"
													class="form-control" onblur="fetchHolidays()" onChange="validatevalue();" />
												...
												<table id="tb_DateDescription" class="aui">
													...
													<tbody>
														<tr id="table_row">
															...
															<td><label class="v_status" id="v_status"></label>
															</td>
															<td>
						...
						<aui:col span="12">
							...
							<div class="form-group formio-component-textfield has-error">
								<input type="text" name="date" autocomplete="off"
									...
									<div class="formio-errors invalid-feedback help-block" id="date"
									style="display: none">date is required</div>
							</div>
						...
						<aui:col span="12">
							...
							<div class="form-group formio-component-textarea has-error">
								<textarea type="text" name="description" maxlength="100"
									...
									<div class="formio-errors invalid-feedback help-block" id="desc"
									style="display: none">Description is required</div>
							       </div>
					...
					<aui:row>
						<aui:col span="12">
							<button type="button" onclick="validateHoliday('Draft')"
								class="btn btn-default" id="draft">SAVE DRAFT</button>
		...
		setTimeout(
				function() {
					var overlay = document
							.getElementsByClassName("yui3-widget-mask")[0];
