...
/**
 * Provides the local service interface for SPJobRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author harini
 * @see SPJobRoleLocalServiceUtil
...
public interface SPJobRoleLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPJobRoleLocalServiceUtil} to access the s p job role local service. Add custom service methods to {@link com.sambaash.platform.srv.extendedprofile.service.impl.SPJobRoleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
