...
/**
 * Provides the local service interface for SPCertification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author harini
 * @see SPCertificationLocalServiceUtil
...
public interface SPCertificationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPCertificationLocalServiceUtil} to access the s p certification local service. Add custom service methods to {@link com.sambaash.platform.srv.extendedprofile.service.impl.SPCertificationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
