package com.sambaash.platform.invigilatormanagement.updateappointment;
...
import com.sambaash.platform.invigilatormanagement.action.ajax.UpdateAppointmentActionHandler;


/**
 * Portlet implementation class UpdateAppointmentPortlet
 */
public class UpdateAppointmentPortlet extends MVCPortlet {
	...
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("updateAppointment", UpdateAppointmentActionHandler.class);
	}
	/**
     * This is an object of Log class
     */
    private Log log = LogFactoryUtil.getLog(UpdateAppointmentPortlet.class.getName());
