...
import com.sambaash.platform.finance.ajax.CheckLORActionHandler;
...
import com.sambaash.platform.finance.ajax.FetchTodayRecordActionHandler;
 ...
 */
public class CashierCounterPortlet extends MVCPortlet {
	...
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("checkLOR", CheckLORActionHandler.class);
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("todayRecord", FetchTodayRecordActionHandler.class);
	 ...
	 */
	private Log log = LogFactoryUtil.getLog(CashierCounterPortlet.class.getName());
