...
/**
 * Provides the local service interface for FormsMicroservice. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author glenn
 * @see FormsMicroserviceLocalServiceUtil
...
public interface FormsMicroserviceLocalService extends BaseLocalService,
	InvokableLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FormsMicroserviceLocalServiceUtil} to access the forms microservice local service. Add custom service methods to {@link com.sambaash.platform.srv.spmicroservice.service.impl.FormsMicroserviceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
