...
public class StatusLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return StatusLocalServiceUtil.addStatus((com.sambaash.platform.srv.spchat.model.Status)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return StatusLocalServiceUtil.deleteStatus((com.sambaash.platform.srv.spchat.model.Status)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return StatusLocalServiceUtil.updateStatus((com.sambaash.platform.srv.spchat.model.Status)arguments[0]);
		}
