									...
									<aui:col span="12" cssClass="formio-component-textfield">
										<div class="form-group">
											...
											<label id="fileUploadLabel" class="btn btn-default">
												ADD FILE <input type="file" accept="application/pdf" size="61" style=""
												name="templateFile"
							...
							<aui:col span="10">
								<aui:col span="3">
									<button type="button" class="btn btn-default" id="draft"
										onClick="validateAndSubmit('draft')">Save Draft</button>
								</aui:col>
								<aui:col span="3">
									<button type="button" class="btn btn-primary" id="publish"
										onClick="validateAndSubmit('publish')">Publish</button>
								</aui:col>
								<aui:col span="3">
