 ...
 * @generated
 */
public abstract class ReAccreditationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ReAccreditationActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ReAccreditationLocalServiceUtil.getService());
		setClass(ReAccreditation.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("accreditationId");
	}
}