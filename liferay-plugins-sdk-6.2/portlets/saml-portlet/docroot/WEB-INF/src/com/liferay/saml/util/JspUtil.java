...
public class JspUtil {
	...
	public static void dispatch(
		...
		dispatch(request, response, path, title, null, false);
	}
	...
	public static void dispatch(
		...
		dispatch(request, response, path, title, null, popUp);
	}

	public static void dispatch(
			HttpServletRequest request, HttpServletResponse response,
			String path, String title, String message)
		throws Exception {

		dispatch(request, response, path, title, message, false);
	}

	public static void dispatch(
			HttpServletRequest request, HttpServletResponse response,
			String path, String title, String message, boolean popUp)
		throws Exception {
