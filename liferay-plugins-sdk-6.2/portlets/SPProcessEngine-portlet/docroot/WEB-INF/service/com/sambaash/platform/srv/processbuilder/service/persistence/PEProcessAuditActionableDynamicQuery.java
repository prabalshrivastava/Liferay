 ...
 * @generated
 */
public abstract class PEProcessAuditActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PEProcessAuditActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PEProcessAuditLocalServiceUtil.getService());
		setClass(PEProcessAudit.class);

		setClassLoader(com.sambaash.platform.srv.processbuilder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPEProcessAuditId");
	}
}