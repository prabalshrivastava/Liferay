...
<script>
var config = {
		recordManuallyPage: "/html/invigilatorattendance/view.jsp",
		recordBarcodePage: "/html/invigilatorattendance/barcode.jsp"
	};
...
<jsp:include page="detail-section.jsp" /> 
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/detail-section.js?<%=System.currentTimeMillis()%>" language="javascript1.2"></script>