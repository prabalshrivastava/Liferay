 ...
 * @generated
 */
public abstract class SPSellingPriceActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPSellingPriceActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPSellingPriceLocalServiceUtil.getService());
		setClass(SPSellingPrice.class);

		setClassLoader(com.sambaash.platform.srv.spshopping.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spSellingPriceId");
	}
}