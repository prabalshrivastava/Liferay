			...
			<div class=" block full-width relative" id="heading">
				...
				<div class="site-main-logo absolute pin-top-left inline-block ">
					<a class="${logo_css_class}" href="${site_default_url}" title="<@liferay.language_format arguments="${site_name}" key="go-to-x" />">
						<img src="${themeDisplay.getPathThemeImages()}/menu/company_logo.png" alt="logo" class="blackLogo">
					</a>
...
<#if themeDisplay.getPortalURL()?contains("www.stream.com")>
