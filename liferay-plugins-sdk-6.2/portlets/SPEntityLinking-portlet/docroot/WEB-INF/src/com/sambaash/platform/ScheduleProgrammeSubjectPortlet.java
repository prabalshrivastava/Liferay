...
import com.sambaash.platform.action.ajax.LoadDataActionHandler;
...
/**
 * Portlet implementation class ScheduleProgrammeSubjectPortlet
 */
public class ScheduleProgrammeSubjectPortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(ScheduleProgrammeSubjectPortlet.class.getName());
