...
/**
 * Provides the local service interface for SPDiscount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pradeep
 * @see SPDiscountLocalServiceUtil
...
public interface SPDiscountLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPDiscountLocalServiceUtil} to access the s p discount local service. Add custom service methods to {@link com.sambaash.platform.srv.spshopping.service.impl.SPDiscountLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
