 ...
 * @generated
 */
public abstract class SPMailTemplateActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPMailTemplateActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPMailTemplateLocalServiceUtil.getService());
		setClass(SPMailTemplate.class);

		setClassLoader(com.sambaash.platform.srv.mail.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spMailTemplateId");
	}
}