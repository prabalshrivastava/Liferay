...
/**
 * Provides the local service interface for SPOrgContactUs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pradeep
 * @see SPOrgContactUsLocalServiceUtil
...
public interface SPOrgContactUsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPOrgContactUsLocalServiceUtil} to access the s p org contact us local service. Add custom service methods to {@link com.sambaash.platform.srv.startupprofile.service.impl.SPOrgContactUsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
