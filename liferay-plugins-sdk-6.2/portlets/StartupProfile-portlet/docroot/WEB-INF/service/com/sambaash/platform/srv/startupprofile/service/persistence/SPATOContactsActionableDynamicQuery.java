 ...
 * @generated
 */
public abstract class SPATOContactsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPATOContactsActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPATOContactsLocalServiceUtil.getService());
		setClass(SPATOContacts.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spATOContactId");
	}
}