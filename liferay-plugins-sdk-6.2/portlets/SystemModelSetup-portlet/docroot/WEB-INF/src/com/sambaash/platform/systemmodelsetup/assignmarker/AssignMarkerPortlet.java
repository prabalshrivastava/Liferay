package com.sambaash.platform.systemmodelsetup.assignmarker;
...
import com.sambaash.platform.systemmodelsetup.currencyexchange.CurrencyExchangePortlet;

/**
 * Portlet implementation class AssignMarkerPortlet
 */
public class AssignMarkerPortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(CurrencyExchangePortlet.class.getName());
    
    @Override
    public void serveResource(ResourceRequest resourceRequest,ResourceResponse resourceResponse)throws  IOException, PortletException {
	    try {
		    log.info("log---"+ resourceRequest.toString());
    ...
    public void savePreferences(ActionRequest actionRequest,
		...
		String listHeader = ParamUtil.getString(actionRequest, SystemSetupConstants.PREF_LIST_HEADER, "");
		try {
			...
			preferences.setValue(SystemSetupConstants.PREF_LIST_HEADER, listHeader);
			preferences.store();
