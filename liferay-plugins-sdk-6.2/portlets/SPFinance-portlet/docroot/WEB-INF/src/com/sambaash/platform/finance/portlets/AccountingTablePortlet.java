...
/**
 * Portlet implementation class AccountingTablePortlet
 */
public class AccountingTablePortlet extends MVCPortlet {
	 ...
	 */
	private Log log = LogFactoryUtil.getLog(ProfitCentrePortlet.class.getName());
