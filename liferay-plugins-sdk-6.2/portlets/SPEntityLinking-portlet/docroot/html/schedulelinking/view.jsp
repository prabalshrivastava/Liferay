				...
				<div class="entitySearch">
					<aui:row>
						...
						<div class="selectedItem slectedItem">
							...
							<aui:input type="text"  name="right" placeholder="Search for a ${rightModel} title or code" onchange="getList('Programme','right');"></aui:input>
						</aui:col>
					</aui:row>
					<aui:row>
   ...
   <form class="formContainer" >
     ...
     <aui:row>
      	<aui:col span="12">
      		...
      		<button class="btn btn-default pull-right" type="button" onClick="moveToDashboard()">DashBoard</button>
      	</aui:col>
     </aui:row>
...
var fetchLeftLinkType = "ScheduleEntityLink";
...
function getList(modelName,side){
	...
	if(side == "left"){
		...
		filter["contentJson.Category"] = ["Programme"];	
...
function reloadListing(div,data){
	...
	for(var i =0; i <data.length; i++){
		...
		if(div == "programmeDiv"){
			...
			obj.value = data[i].contentJson.Name;
