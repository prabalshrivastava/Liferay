 ...
 * @generated
 */
public class SPJobLocalServiceClp implements SPJobLocalService {
	public SPJobLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName23 = "closeJob";

		_methodParameterTypes23 = new String[] { "long" };

		_methodName24 = "addSPJob";
	...
	public com.sambaash.platform.srv.spjob.model.SPJob addSPJob(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(spJob) });
		}
		catch (Throwable t) {
		...
		return (com.sambaash.platform.srv.spjob.model.SPJob)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.sambaash.platform.srv.spjob.model.SPJob createSPJob(long spJobId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { spJobId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.sambaash.platform.srv.spjob.model.SPJob deleteSPJob(long spJobId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { spJobId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.sambaash.platform.srv.spjob.model.SPJob fetchSPJob(long spJobId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { spJobId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.sambaash.platform.srv.spjob.model.SPJob getSPJob(long spJobId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName13,
					_methodParameterTypes13, new Object[] { spJobId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.sambaash.platform.srv.spjob.model.SPJob> getSPJobs(
		...
		return (java.util.List<com.sambaash.platform.srv.spjob.model.SPJob>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public void closeJob(long spJobId)
		...
		try {
			_invokableLocalService.invokeMethod(_methodName23,
				_methodParameterTypes23, new Object[] { spJobId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.sambaash.platform.srv.spjob.model.SPJob addSPJob(long userId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName24,
					...
					ClpSerializer.translateInput(corporateName),
						
					ClpSerializer.translateInput(jobTitle),
						
					ClpSerializer.translateInput(jobType),
						
					ClpSerializer.translateInput(jobLocation),
						
					ClpSerializer.translateInput(yoe),
						
					ClpSerializer.translateInput(jobDescription),
						
					ClpSerializer.translateInput(status),
						
					ClpSerializer.translateInput(imageFileName),
						
					ClpSerializer.translateInput(imageInputStream),
						
					imageMaxSize,
						
					ClpSerializer.translateInput(imageExtensions),
						
					ClpSerializer.translateInput(currency),
						
					ClpSerializer.translateInput(salary),
						
					ClpSerializer.translateInput(rate),
						
					ClpSerializer.translateInput(startDate),
						
					ClpSerializer.translateInput(endDate),
						
					ClpSerializer.translateInput(closingDate),
						
					ClpSerializer.translateInput(notefTo),
	...
	public void updateAsset(long userId,
		...
		try {
			_invokableLocalService.invokeMethod(_methodName26,
				...
				ClpSerializer.translateInput(spJob),
