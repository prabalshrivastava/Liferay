...
/**
 * Provides the local service interface for MembershipPackageAddonServices. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see MembershipPackageAddonServicesLocalServiceUtil
...
public interface MembershipPackageAddonServicesLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MembershipPackageAddonServicesLocalServiceUtil} to access the membership package addon services local service. Add custom service methods to {@link com.sambaash.platform.srv.spservices.service.impl.MembershipPackageAddonServicesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
