...
package com.sambaash.platform.srv.processbuilder.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			FormBuilderLocalServiceUtil.clearService();

			FormBuilderServiceUtil.clearService();
			PECustomActionInfoLocalServiceUtil.clearService();

			PEDummyEntityLocalServiceUtil.clearService();

			PEEngineLocalServiceUtil.clearService();

			PEEngineServiceUtil.clearService();
			PEProcessLocalServiceUtil.clearService();

			PEProcessAuditLocalServiceUtil.clearService();

			PEProcessStageLocalServiceUtil.clearService();

			PEProcessStateLocalServiceUtil.clearService();

			PEProcessStatusTypeLocalServiceUtil.clearService();

			PERuleLocalServiceUtil.clearService();

			PERuleSetLocalServiceUtil.clearService();

			PESupervisorLocalServiceUtil.clearService();
		}
	}
}