package com.sambaash.platform.proctorrostor.report;
...
import com.sambaash.platform.proctorrostor.ajax.ExportPdfActionHandler;
import com.sambaash.platform.proctorrostor.ajax.CreateActionHandler;
import com.sambaash.platform.constant.SystemSetupConstants;
import com.sambaash.platform.proctorrostor.ajax.ElasticSearchListActionHandler;
import com.sambaash.platform.proctorrostor.ajax.ExportListActionHandler;
import com.sambaash.platform.proctorrostor.ajax.ExportRowActionHandler;
import com.sambaash.platform.proctorrostor.ajax.FetchActionHandler;
import com.sambaash.platform.proctorrostor.ajax.FetchFormFieldsActionHandler;
import com.sambaash.platform.proctorrostor.ajax.FileDownloadActionHandler;
import com.sambaash.platform.proctorrostor.ajax.FilterColumnListActionHandler;
import com.sambaash.platform.proctorrostor.ajax.LoadListActionHandler;
import com.sambaash.platform.proctorrostor.ajax.SearchListActionHandler;

/**
 * Portlet implementation class InvigilatorAttendance
 */
public class ProctorRostorReport extends MVCPortlet {
	private static final ServeResourceActionManager SERVE_RESOURCE_MANAGER;

	private Log log = LogFactoryUtil
			.getLog(ProctorRostorReport.class.getName());
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("exportPdf",
				ExportPdfActionHandler.class);
	}
