...
package com.sambaash.platform.srv.enrolment.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			EnrollBatchUploadLocalServiceUtil.clearService();

			EnrollUploadedTempRecordsLocalServiceUtil.clearService();
		}
	}
}