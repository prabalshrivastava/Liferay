...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/password.js?<%=System.currentTimeMillis()%>"
...
<portlet:renderURL var="changeEmailURL" >
	<portlet:param name="jspPage" value="/html/changeemail/changeEmail.jsp" />
...
<div class="container">
		<div class="text-center">
			...
			<aui:col span='10' cssClass="offset1 text-center userAction">
				<div class="tab">
					<button id="bt_password" type="button" class="btn btn-default" onclick="callChangeEmail()">EMAIL</button>
				</div>
...
function callChangeEmail(){
	location.href =  "${changeEmailURL}";
}
