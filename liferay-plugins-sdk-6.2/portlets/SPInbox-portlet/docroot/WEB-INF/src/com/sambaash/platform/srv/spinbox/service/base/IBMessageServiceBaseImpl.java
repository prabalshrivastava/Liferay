...
import com.sambaash.platform.srv.spinbox.service.IBMessageService;
...
/**
 * Provides the base implementation for the i b message remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.spinbox.service.impl.IBMessageServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class IBMessageServiceBaseImpl extends BaseServiceImpl
	implements IBMessageService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.spinbox.service.IBMessageServiceUtil} to access the i b message remote service.
	 */
	...
	private IBMessageServiceClpInvoker _clpInvoker = new IBMessageServiceClpInvoker();
}