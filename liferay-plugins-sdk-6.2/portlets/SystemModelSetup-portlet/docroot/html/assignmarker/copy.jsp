...
<%
String formId = portletPreferences.getValue(SystemSetupConstants.PREF_HTML_FORM_ID, "2014");
...
function afterFormDataLoadedFormIOForm(thisInstance){
	thisInstance.components.MarkerName.setValue("Copy-of-"+ thisInstance.components.MarkerName.value);
}
