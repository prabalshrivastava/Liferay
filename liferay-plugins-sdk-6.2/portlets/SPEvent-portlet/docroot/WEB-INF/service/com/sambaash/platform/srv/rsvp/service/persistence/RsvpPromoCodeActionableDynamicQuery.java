 ...
 * @generated
 */
public abstract class RsvpPromoCodeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RsvpPromoCodeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RsvpPromoCodeLocalServiceUtil.getService());
		setClass(RsvpPromoCode.class);

		setClassLoader(com.sambaash.platform.srv.rsvp.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("rsvpPromoCodeId");
	}
}