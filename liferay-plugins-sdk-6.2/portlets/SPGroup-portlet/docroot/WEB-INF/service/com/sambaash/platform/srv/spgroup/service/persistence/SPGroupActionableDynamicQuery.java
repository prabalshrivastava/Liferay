 ...
 * @generated
 */
public abstract class SPGroupActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPGroupActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPGroupLocalServiceUtil.getService());
		setClass(SPGroup.class);

		setClassLoader(com.sambaash.platform.srv.spgroup.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spGroupId");
	}
}