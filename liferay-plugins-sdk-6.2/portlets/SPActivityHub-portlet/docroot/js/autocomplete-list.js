...
YUI.add('autocomplete-userlist', function (Y, NAME) {

/**
Traditional autocomplete dropdown list widget, just like Mom used to make.

@module autocomplete
@submodule autocomplete-userlist
**/
...
List = Y.Base.create('autocompleteList', Y.Widget, [
  ...
  /*  _createItemNode: function (result) {
        ...
        return itemNode.addClass(this[_CLASS_ITEM]).setAttrs({
            id  : Y.stamp(itemNode),
            role: 'option'
        }).innerHTML('data-text', result.text).append(result.display);
    },*/
    ...
    _createItemNode: function (result) {
        ...
        var xEmail = document.createElement("span");
        var xName = document.createElement("p");
        xImg.src =  res[0];
        xEmail.innerHTML = res[2];
        xName.innerHTML = res[1];
        itemNode.append(xImg);
        itemNode.append(xName);
        itemNode.append(xEmail);
        return itemNode;
    },
    ...
    **/
    ...
    ATTRS: {
        ...
        **/
        strings: {
            valueFn: function () {
                return Y.Intl.get('autocomplete-userlist');
            }
        },
