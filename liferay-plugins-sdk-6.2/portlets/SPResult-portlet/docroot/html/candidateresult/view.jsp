...
<br />
						<aui:row>
							...
							<aui:col span="12" cssClass="formio-component-textfield">
								...
								<aui:select name="" disabled="disabled" id="programTitle"
												...
												<aui:row>
													<aui:row>
														...
														<input type="hidden" name="program" class="program" ></input>
															<label cssClass="control-label">Choose a Result type: <span
																...
																<label> 
																	<input disabled="disabled"  type="checkbox" class="resultTypeGRADE" name="resultTypeGRADE" value="GRADE" checked="checked" onchange="resultTypeGRADEChange(this)"> 
																	<span class="listSpanTitleDefault" >Grade</span>
																</label>
																<label> 
																	<input disabled="disabled" type="checkbox" class="resultTypeCA" value="ClassificationAward" name="resultTypeCA" onchange="resultTypeCAChange(this)"> 
													...
													<aui:row cssClass="ClassificationAward" style="display: none;">
														...
														<label cssclass="control-label">Award:</label><hr></hr>
															...
															<aui:select  disabled="disabled" name="" id="awardTitle"
