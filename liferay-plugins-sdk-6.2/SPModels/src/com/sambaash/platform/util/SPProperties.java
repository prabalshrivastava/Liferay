...
public class SPProperties extends Properties {

	private static final long serialVersionUID = -2581867746625699304L;

	public void store(Writer writer, String comments, String delimeter)
			throws IOException {
		store0((writer instanceof BufferedWriter) ? (BufferedWriter) writer
				: new BufferedWriter(writer), comments, false, delimeter);
	}
