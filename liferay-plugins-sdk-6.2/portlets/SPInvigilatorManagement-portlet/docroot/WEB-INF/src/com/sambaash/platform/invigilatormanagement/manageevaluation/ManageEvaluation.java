package com.sambaash.platform.invigilatormanagement.manageevaluation;
...
import com.sambaash.platform.invigilatormanagement.manageevaluation.ManageEvaluation;

/**
 * Portlet implementation class ManageEvaluation
 */
public class ManageEvaluation extends MVCPortlet {
	...
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("scheduleData", ScheduleListActionHandler.class);

 }
	/**
     * This is an object of Log class
     */
    private Log log = LogFactoryUtil.getLog(ManageEvaluation.class.getName());
