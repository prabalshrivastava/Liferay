...
/**
 * Provides the local service interface for SPJobEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pradeep
 * @see SPJobEntryLocalServiceUtil
...
public interface SPJobEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPJobEntryLocalServiceUtil} to access the s p job entry local service. Add custom service methods to {@link com.sambaash.platform.srv.spscheduler.service.impl.SPJobEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
