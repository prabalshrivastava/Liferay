...
import com.sambaash.platform.srv.enrolment.service.EnrollUploadedTempRecordsLocalService;
...
/**
 * Provides the base implementation for the enroll uploaded temp records local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.enrolment.service.impl.EnrollUploadedTempRecordsLocalServiceImpl}.
 * </p>
 *
 * @author Baxture
 ...
 * @generated
 */
public abstract class EnrollUploadedTempRecordsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements EnrollUploadedTempRecordsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.enrolment.service.EnrollUploadedTempRecordsLocalServiceUtil} to access the enroll uploaded temp records local service.
	 */
	...
	@Override
	public EnrollUploadedTempRecords addEnrollUploadedTempRecords(
		EnrollUploadedTempRecords enrollUploadedTempRecords)
		throws SystemException {
		enrollUploadedTempRecords.setNew(true);

		return enrollUploadedTempRecordsPersistence.update(enrollUploadedTempRecords);
	}
	 ...
	 */
	@Override
	public EnrollUploadedTempRecords createEnrollUploadedTempRecords(
		long uploadedRecId) {
		return enrollUploadedTempRecordsPersistence.create(uploadedRecId);
	}
	...
	@Override
	public EnrollUploadedTempRecords deleteEnrollUploadedTempRecords(
		long uploadedRecId) throws PortalException, SystemException {
		return enrollUploadedTempRecordsPersistence.remove(uploadedRecId);
	}
	...
	public EnrollUploadedTempRecords deleteEnrollUploadedTempRecords(
		EnrollUploadedTempRecords enrollUploadedTempRecords)
		throws SystemException {
		return enrollUploadedTempRecordsPersistence.remove(enrollUploadedTempRecords);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EnrollUploadedTempRecords.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return enrollUploadedTempRecordsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return enrollUploadedTempRecordsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EnrollUploadedTempRecords fetchEnrollUploadedTempRecords(
		long uploadedRecId) throws SystemException {
		return enrollUploadedTempRecordsPersistence.fetchByPrimaryKey(uploadedRecId);
	}
	 ...
	 */
	@Override
	public EnrollUploadedTempRecords getEnrollUploadedTempRecords(
		long uploadedRecId) throws PortalException, SystemException {
		return enrollUploadedTempRecordsPersistence.findByPrimaryKey(uploadedRecId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return enrollUploadedTempRecordsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EnrollUploadedTempRecords> getEnrollUploadedTempRecordses(
		int start, int end) throws SystemException {
		return enrollUploadedTempRecordsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEnrollUploadedTempRecordsesCount() throws SystemException {
		return enrollUploadedTempRecordsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EnrollUploadedTempRecords updateEnrollUploadedTempRecords(
		EnrollUploadedTempRecords enrollUploadedTempRecords)
		throws SystemException {
		return enrollUploadedTempRecordsPersistence.update(enrollUploadedTempRecords);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords",
			enrollUploadedTempRecordsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = enrollUploadedTempRecordsPersistence.getDataSource();
	...
	private EnrollUploadedTempRecordsLocalServiceClpInvoker _clpInvoker = new EnrollUploadedTempRecordsLocalServiceClpInvoker();
}