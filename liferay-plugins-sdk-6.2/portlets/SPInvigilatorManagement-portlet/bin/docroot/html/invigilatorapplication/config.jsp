...
<%
	...
	String submitClaimUrl = renderRequest.getPreferences().getValue("submitClaimUrlPref","");
...
<aui:row cssClass="ps-pref-container" style="margin:10px auto; max-width:640px">
	<aui:col span="12">
		<aui:form name="editPreferences" action="<%=savePreferencesActionURL%>">			
			...
			<aui:input name="submitClaimUrlPref" label="Submit Claim URL" value='<%=submitClaimUrl%>'></aui:input>
			<aui:button-row>
