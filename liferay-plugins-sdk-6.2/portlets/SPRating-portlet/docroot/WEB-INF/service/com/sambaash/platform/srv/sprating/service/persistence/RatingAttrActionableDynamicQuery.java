 ...
 * @generated
 */
public abstract class RatingAttrActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RatingAttrActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RatingAttrLocalServiceUtil.getService());
		setClass(RatingAttr.class);

		setClassLoader(com.sambaash.platform.srv.sprating.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spRatingAttrId");
	}
}