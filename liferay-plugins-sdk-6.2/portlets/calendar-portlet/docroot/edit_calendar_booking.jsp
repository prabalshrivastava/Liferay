...
<script type="text/javascript" src="/calendar-portlet/js/upload.js">
</script>
...
<portlet:resourceURL var="uploadFileResourceURL">
	<portlet:param name="action" value="imageUpload" />
</portlet:resourceURL>
...
<aui:form action="<%= updateCalendarBookingURL %>" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "updateCalendarBooking();" %>' enctype="multipart/form-data">
	...
	<aui:input name="eventTempFolderId" id="eventTempFolderId" type="hidden" />
	<aui:input name="eventTempFileEntryId" id="eventTempFileEntryId" type="hidden" value="0"/>
	...
	<aui:fieldset>
	 ...
	 <div>
			<span class="aui-field-label"> Event Images</span>
		</div>
	
 <div id="<portlet:namespace />html5-uploader" class=>
						<p style="display: inline-block;">Upload your files :</p>
						<input id="multi-upload" type="file" />
						<div id="select-zone" style="margin-bottom: 10px;">
