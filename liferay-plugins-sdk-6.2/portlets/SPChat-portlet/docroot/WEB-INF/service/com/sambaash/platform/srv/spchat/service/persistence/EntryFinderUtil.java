...
public class EntryFinderUtil {
	public static java.util.List<com.sambaash.platform.srv.spchat.model.Entry> findByEmptyContent(
	...
	public static java.util.List<com.sambaash.platform.srv.spchat.model.Entry> findByNew(
		long userId, long createDate, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder().findByNew(userId, createDate, start, end);
	}

	public static java.util.List<com.sambaash.platform.srv.spchat.model.Entry> findByOld(
	...
	public static EntryFinder getFinder() {
		if (_finder == null) {
			_finder = (EntryFinder)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.spchat.service.ClpSerializer.getServletContextName(),
