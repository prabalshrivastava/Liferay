...
/**
 * Provides the local service interface for CourseEnrollEsignInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see CourseEnrollEsignInfoLocalServiceUtil
...
public interface CourseEnrollEsignInfoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CourseEnrollEsignInfoLocalServiceUtil} to access the course enroll esign info local service. Add custom service methods to {@link com.sambaash.platform.srv.service.impl.CourseEnrollEsignInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
