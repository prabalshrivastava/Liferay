...
/**
 * Provides the remote service interface for Fetch. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author biswo
 * @see FetchServiceUtil
...
public interface FetchService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FetchServiceUtil} to access the fetch remote service. Add custom service methods to {@link com.sambaash.platform.service.impl.FetchServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
