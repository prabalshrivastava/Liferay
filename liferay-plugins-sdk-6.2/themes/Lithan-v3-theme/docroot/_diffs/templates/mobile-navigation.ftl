		...
		<div class="heading-mobile">
				<div class="site-main-logo absolute pin-top-left inline-block ">
					<a class="${logo_css_class}" href="${site_default_url}" title="<@liferay.language_format arguments="${site_name}" key="go-to-x" />">
						<img alt="Search" src="${themeDisplay.getPathThemeImages()}/menu/LithanHall_Logo2Footer.png" alt="logo" class="blackLogo">
					</a>
	                  	...
	                  	<div class="searchBtn"></div>
		                     <div class="dropdown-search" id="dropdown-search">
		                        ...
		                        <div class="mobileheader_search_icon">
									<img src="${themeDisplay.getPathThemeImages()}/menu/mobilesearch.svg">
								</div>
	                    	</div>
	                 </div>
					...
					<div class="dropdown">
	                  	<div class="dropbtn"></div>
		                     <div class="dropdown-content">
		                        <#if is_signed_in>
		                            <a href="${themeDisplay.getUser().getScreenName()}"><div class="profile"></div>My Profile</a>
