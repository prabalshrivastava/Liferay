...
<div class="subHeader">
	<div class="container">
		<aui:row>
			<aui:col span="10" cssClass="text-center"><h2>Price Scheme Linking</h2></aui:col>
		...
		<aui:row cssClass="entityTab">
			...
			<aui:col span="6" cssClass="text-center posRelative"><em class="subIcon"></em>
				<select id="rightDropdown" onchange="rightDropdownChanged()">
					<option value="price-scheme">PRICING SCHEME</option>
				</select>
			</aui:col>
		</aui:row>
		...
		<aui:row cssClass="entitylinkBox">
			...
			<aui:col span="6" cssClass="text-center">
				<div class="entitySearch">
					...
					<aui:row>
						<div class="priceSchemeDiv" id="priceSchemeDiv"> 
							<aui:col span="12">
								<ul>
									<li>
									<label> 
