...
import com.sambaash.platform.finance.ajax.FetchInvoiceReceiptActionHandler;
 ...
 */
public class PayOnlinePortlet extends MVCPortlet {
	...
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("fetchInvoiceReceipt", FetchInvoiceReceiptActionHandler.class);
	}
	/**
	 * This is an object of Log class
	 */
	private Log log = LogFactoryUtil.getLog(PayOnlinePortlet.class.getName());
	...
	public void savePreferences(ActionRequest actionRequest, ActionResponse actionResponse) {
		...
		String isNotify = ParamUtil.getString(actionRequest, FinanceConstants.PREF_IS_NOTIFY, "");
		String emailAddresses = ParamUtil.getString(actionRequest, FinanceConstants.PREF_EMAIL_ADRESSES, "");
		try {
			...
			preferences.setValue(FinanceConstants.PREF_IS_NOTIFY, isNotify);
			preferences.setValue(FinanceConstants.PREF_EMAIL_ADRESSES, emailAddresses);
			preferences.store();
