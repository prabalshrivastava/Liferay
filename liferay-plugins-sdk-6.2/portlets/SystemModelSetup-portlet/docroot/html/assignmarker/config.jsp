...
<%
	...
	String listHeaderPref = renderRequest.getPreferences().getValue("listHeaderPref","");
...
<aui:row cssClass="ps-pref-container" style="margin:10px auto; max-width:640px">
	<aui:col span="12">
		<aui:form name="editPreferences" action="<%=savePreferencesActionURL%>">			
			...
			<aui:input name="listHeaderPref" label="List Header Name" value='<%=listHeaderPref%>'></aui:input>
			<aui:button-row>
