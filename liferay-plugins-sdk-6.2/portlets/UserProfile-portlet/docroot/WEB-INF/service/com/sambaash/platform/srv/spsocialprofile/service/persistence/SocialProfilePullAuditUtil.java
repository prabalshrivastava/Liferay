...
/**
 * The persistence utility for the social profile pull audit service. This utility wraps {@link SocialProfilePullAuditPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class SocialProfilePullAuditUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(SocialProfilePullAudit socialProfilePullAudit) {
		getPersistence().clearCache(socialProfilePullAudit);
	}
	 ...
	 */
	public static List<SocialProfilePullAudit> findWithDynamicQuery(
	 ...
	 */
	public static SocialProfilePullAudit update(
		SocialProfilePullAudit socialProfilePullAudit)
		throws SystemException {
		return getPersistence().update(socialProfilePullAudit);
	}
	...
	public static SocialProfilePullAudit update(
		...
		return getPersistence().update(socialProfilePullAudit, serviceContext);
	}
	...
	*/
	public static com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit findByUserIdAndSocialNetworkProfileId(
		...
		return getPersistence()
				   .findByUserIdAndSocialNetworkProfileId(companyId, userId,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit fetchByUserIdAndSocialNetworkProfileId(
		long companyId, long userId, long socialNetworkProfileId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .fetchByUserIdAndSocialNetworkProfileId(companyId, userId,
			socialNetworkProfileId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit removeByUserIdAndSocialNetworkProfileId(
		long companyId, long userId, long socialNetworkProfileId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.spsocialprofile.NoSuchSocialProfilePullAuditException {
		return getPersistence()
				   .removeByUserIdAndSocialNetworkProfileId(companyId, userId,
			socialNetworkProfileId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int countByUserIdAndSocialNetworkProfileId(long companyId,
		long userId, long socialNetworkProfileId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .countByUserIdAndSocialNetworkProfileId(companyId, userId,
			socialNetworkProfileId);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(socialProfilePullAudit);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(socialProfilePullAudits);
	}
	...
	*/
	public static com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit create(
		SocialProfilePullAuditPK socialProfilePullAuditPK) {
		return getPersistence().create(socialProfilePullAuditPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit remove(
		SocialProfilePullAuditPK socialProfilePullAuditPK)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.spsocialprofile.NoSuchSocialProfilePullAuditException {
		return getPersistence().remove(socialProfilePullAuditPK);
	}

	public static com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit updateImpl(
		com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit socialProfilePullAudit)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(socialProfilePullAudit);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit findByPrimaryKey(
		SocialProfilePullAuditPK socialProfilePullAuditPK)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.spsocialprofile.NoSuchSocialProfilePullAuditException {
		return getPersistence().findByPrimaryKey(socialProfilePullAuditPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit fetchByPrimaryKey(
		SocialProfilePullAuditPK socialProfilePullAuditPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(socialProfilePullAuditPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.spsocialprofile.model.SocialProfilePullAudit> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static SocialProfilePullAuditPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SocialProfilePullAuditPersistence)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.spsocialprofile.service.ClpSerializer.getServletContextName(),
					SocialProfilePullAuditPersistence.class.getName());

			ReferenceRegistry.registerReference(SocialProfilePullAuditUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(SocialProfilePullAuditPersistence persistence) {
	}

	private static SocialProfilePullAuditPersistence _persistence;
}