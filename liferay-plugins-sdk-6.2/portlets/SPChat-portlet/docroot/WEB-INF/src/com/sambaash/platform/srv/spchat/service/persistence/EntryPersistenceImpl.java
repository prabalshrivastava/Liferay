...
import com.sambaash.platform.srv.spchat.NoSuchEntryException;
import com.sambaash.platform.srv.spchat.model.Entry;
import com.sambaash.platform.srv.spchat.model.impl.EntryImpl;
import com.sambaash.platform.srv.spchat.model.impl.EntryModelImpl;
...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	@Override
	public Entry updateImpl(com.sambaash.platform.srv.spchat.model.Entry entry)
		throws SystemException {
		entry = toUnwrappedModel(entry);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.sambaash.platform.srv.spchat.model.Entry")));
