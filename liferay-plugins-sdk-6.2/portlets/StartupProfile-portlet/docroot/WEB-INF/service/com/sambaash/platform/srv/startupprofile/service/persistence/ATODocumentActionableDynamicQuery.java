 ...
 * @generated
 */
public abstract class ATODocumentActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ATODocumentActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ATODocumentLocalServiceUtil.getService());
		setClass(ATODocument.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("atoDocumentId");
	}
}