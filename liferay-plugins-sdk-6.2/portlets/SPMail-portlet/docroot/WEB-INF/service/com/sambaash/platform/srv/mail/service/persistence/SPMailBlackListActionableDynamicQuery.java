 ...
 * @generated
 */
public abstract class SPMailBlackListActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPMailBlackListActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPMailBlackListLocalServiceUtil.getService());
		setClass(SPMailBlackList.class);

		setClassLoader(com.sambaash.platform.srv.mail.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spMailBlackListId");
	}
}