...
%>
	...
	config.extraPlugins = 'ajaxsave,media,restore,scayt,wsc,pastetext';
	...
	config.toolbar_editInPlaceWithLink = [
		['Styles'],
		['Bold', 'Italic', 'Underline', 'Strike'],
		['Subscript', 'Superscript', 'SpecialChar'],
		['Undo', 'Redo'],
	...
	config.toolbar_liferayArticle_withoutImage = [
		['Styles', 'FontSize', '-', 'TextColor', 'BGColor'],
		['Bold', 'Italic', 'Underline', 'Strike'],
		['Subscript', 'Superscript'],
		'/',
		...
		['Source'],
		['Link', 'Unlink', 'Anchor'],
		['Flash', 'Table', '-', 'Smiley', 'SpecialChar', 'LiferayPageBreak']
	];
