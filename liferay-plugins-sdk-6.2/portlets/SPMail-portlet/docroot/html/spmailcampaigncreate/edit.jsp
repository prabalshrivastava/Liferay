...
<div style="padding:10px;border:1px solid #666666;width:96%;">
	...
	<div style="width:100%;padding:10px;">
		<div style="width:20%;display:inline-block;color:#000000;font-weight:bold;"> Category Name</div>
		<div style="width:80%;display:inline;"><input type="text" name="<portlet:namespace />categoryName" id="categoryName" value="${categoryName}" /></div>
	</div>
