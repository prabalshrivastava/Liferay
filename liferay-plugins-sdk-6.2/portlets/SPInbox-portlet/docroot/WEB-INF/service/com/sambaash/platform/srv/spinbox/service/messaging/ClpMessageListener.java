...
package com.sambaash.platform.srv.spinbox.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			IBMessageLocalServiceUtil.clearService();

			IBMessageServiceUtil.clearService();
			IBMessageDetailLocalServiceUtil.clearService();

			IBMessageDetailServiceUtil.clearService();
		}
	}
}