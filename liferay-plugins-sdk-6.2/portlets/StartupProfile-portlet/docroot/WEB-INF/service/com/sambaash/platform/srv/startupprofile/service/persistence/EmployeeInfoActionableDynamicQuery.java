 ...
 * @generated
 */
public abstract class EmployeeInfoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public EmployeeInfoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(EmployeeInfoLocalServiceUtil.getService());
		setClass(EmployeeInfo.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("employeeInfoId");
	}
}