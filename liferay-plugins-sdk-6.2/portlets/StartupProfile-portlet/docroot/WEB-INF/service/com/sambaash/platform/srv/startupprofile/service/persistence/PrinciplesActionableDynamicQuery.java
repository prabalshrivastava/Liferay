 ...
 * @generated
 */
public abstract class PrinciplesActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PrinciplesActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PrinciplesLocalServiceUtil.getService());
		setClass(Principles.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("principleId");
	}
}