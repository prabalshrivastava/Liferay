...
<portlet:renderURL var="announcementListing">
	<portlet:param name="jspPage"
		value="/html/announcementListing/list.jsp" />
</portlet:renderURL>
...
<div class="subHeader">
	<div class="container">
		...
		<aui:row>
			<aui:col span="10" cssClass="text-center"><h2><span>Announcements SETUP</span></h2></aui:col>
