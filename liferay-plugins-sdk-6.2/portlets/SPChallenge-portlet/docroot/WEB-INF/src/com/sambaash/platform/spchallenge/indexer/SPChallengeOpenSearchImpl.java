...
public class SPChallengeOpenSearchImpl extends HitsOpenSearchImpl {

	private static final Log _log = LogFactoryUtil
			.getLog(SPChallengeOpenSearchImpl.class);

	public static final String SEARCH_PATH = "/c/spchallenge/open_search";

	public static final String TITLE = "Challenge & Applicant Search: ";

	@Override
	public Indexer getIndexer() {
		return IndexerRegistryUtil.getIndexer(SPChallenge.class);
	}
	...
	//     TODO    May not be correct..its a copy paste
