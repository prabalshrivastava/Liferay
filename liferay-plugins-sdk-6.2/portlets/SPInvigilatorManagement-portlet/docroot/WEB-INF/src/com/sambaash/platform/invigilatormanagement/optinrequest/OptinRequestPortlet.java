	package com.sambaash.platform.invigilatormanagement.optinrequest;
 ...
 */
public class OptinRequestPortlet extends MVCPortlet {
		...
		private Log _log = LogFactoryUtil.getLog(OptinRequestPortlet.class.getName());
