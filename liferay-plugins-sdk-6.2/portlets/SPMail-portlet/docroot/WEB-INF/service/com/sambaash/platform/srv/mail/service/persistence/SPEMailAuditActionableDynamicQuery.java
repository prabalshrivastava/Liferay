 ...
 * @generated
 */
public abstract class SPEMailAuditActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPEMailAuditActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPEMailAuditLocalServiceUtil.getService());
		setClass(SPEMailAudit.class);

		setClassLoader(com.sambaash.platform.srv.mail.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spEMailAudit");
	}
}