package com.sambaash.platform.userannouncement;
 ...
 */
public class UserAnnouncementPortlet extends MVCPortlet {
 

	private static final Log log = LogFactoryUtil.getLog(UserAnnouncementPortlet.class);
