 ...
 * @generated
 */
public abstract class SPMailLinkTrackingActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPMailLinkTrackingActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPMailLinkTrackingLocalServiceUtil.getService());
		setClass(SPMailLinkTracking.class);

		setClassLoader(com.sambaash.platform.srv.mail.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spMailLinkTrackingId");
	}
}