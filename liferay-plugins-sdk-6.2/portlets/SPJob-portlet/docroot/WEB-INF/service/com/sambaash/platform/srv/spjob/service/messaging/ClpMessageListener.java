...
package com.sambaash.platform.srv.spjob.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SPJobLocalServiceUtil.clearService();

			SPJobApplicantsLocalServiceUtil.clearService();

			SPJobApplicantsPortfolioLocalServiceUtil.clearService();
		}
	}
}