...
/**
 * The persistence utility for the learning duration service. This utility wraps {@link LearningDurationPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class LearningDurationUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(LearningDuration learningDuration) {
		getPersistence().clearCache(learningDuration);
	}
	 ...
	 */
	public static List<LearningDuration> findWithDynamicQuery(
	 ...
	 */
	public static LearningDuration update(LearningDuration learningDuration)
		throws SystemException {
		return getPersistence().update(learningDuration);
	}
	...
	public static LearningDuration update(LearningDuration learningDuration,
		...
		return getPersistence().update(learningDuration, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(learningDuration);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(learningDurations);
	}
	...
	*/
	public static com.sambaash.platform.srv.model.LearningDuration create(
		long spLearningDurationId) {
		return getPersistence().create(spLearningDurationId);
	}
	...
	*/
	public static com.sambaash.platform.srv.model.LearningDuration remove(
		long spLearningDurationId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.NoSuchLearningDurationException {
		return getPersistence().remove(spLearningDurationId);
	}

	public static com.sambaash.platform.srv.model.LearningDuration updateImpl(
		com.sambaash.platform.srv.model.LearningDuration learningDuration)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(learningDuration);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.LearningDuration findByPrimaryKey(
		long spLearningDurationId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.NoSuchLearningDurationException {
		return getPersistence().findByPrimaryKey(spLearningDurationId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.LearningDuration fetchByPrimaryKey(
		long spLearningDurationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(spLearningDurationId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.model.LearningDuration> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static LearningDurationPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LearningDurationPersistence)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.service.ClpSerializer.getServletContextName(),
					LearningDurationPersistence.class.getName());

			ReferenceRegistry.registerReference(LearningDurationUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LearningDurationPersistence persistence) {
	}

	private static LearningDurationPersistence _persistence;
}