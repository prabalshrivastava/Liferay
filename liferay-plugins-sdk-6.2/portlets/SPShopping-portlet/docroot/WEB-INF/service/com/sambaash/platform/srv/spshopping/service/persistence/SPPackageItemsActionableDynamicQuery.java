 ...
 * @generated
 */
public abstract class SPPackageItemsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPPackageItemsActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPPackageItemsLocalServiceUtil.getService());
		setClass(SPPackageItems.class);

		setClassLoader(com.sambaash.platform.srv.spshopping.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPackageItemsId");
	}
}