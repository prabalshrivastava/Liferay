package com.sambaash.platform.systemmodelsetup.bankcode;
...
/**
 * Portlet implementation class BankPortlet
 */
public class BankPortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(BankPortlet.class.getName());
