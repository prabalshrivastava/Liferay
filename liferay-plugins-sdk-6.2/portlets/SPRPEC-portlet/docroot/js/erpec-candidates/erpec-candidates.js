...
//                            reviewPeriodNo = contentdata.totalElements + 1;
                            ...
                            for (var i = 0; i < responseData.length; i++) {
                            	if(responseData[i].contentJson.reviewPeriodNumber + 1 > reviewPeriodNo)
                            	{
                            		reviewPeriodNo = responseData[i].contentJson.reviewPeriodNumber + 1;
                            	}
                            }
                            for (var i = 0; i < responseData.length; i++) {
...
//	var candidateListParse = JSON.parse(candidatesList);
	if (searchTerm !== undefined && searchTerm.length > 0) {
		...
		var filtered = candidateList.filter(function(i) {
			if(typeof i === 'object')
			{
