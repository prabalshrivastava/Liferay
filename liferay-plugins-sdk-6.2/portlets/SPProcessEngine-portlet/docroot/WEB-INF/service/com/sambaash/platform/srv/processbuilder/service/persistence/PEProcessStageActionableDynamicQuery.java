 ...
 * @generated
 */
public abstract class PEProcessStageActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PEProcessStageActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PEProcessStageLocalServiceUtil.getService());
		setClass(PEProcessStage.class);

		setClassLoader(com.sambaash.platform.srv.processbuilder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPEProcessStageId");
	}
}