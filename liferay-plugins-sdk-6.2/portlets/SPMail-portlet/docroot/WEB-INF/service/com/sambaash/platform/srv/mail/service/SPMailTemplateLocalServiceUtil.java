...
/**
 * Provides the local service utility for SPMailTemplate. This utility wraps
 * {@link com.sambaash.platform.srv.mail.service.impl.SPMailTemplateLocalServiceImpl} and is the
 ...
 * @see com.sambaash.platform.srv.mail.service.impl.SPMailTemplateLocalServiceImpl
 * @generated
 */
public class SPMailTemplateLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.sambaash.platform.srv.mail.service.impl.SPMailTemplateLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailTemplate addSPMailTemplate(
		com.sambaash.platform.srv.mail.model.SPMailTemplate spMailTemplate)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addSPMailTemplate(spMailTemplate);
	}
	...
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailTemplate createSPMailTemplate(
		long spMailTemplateId) {
		return getService().createSPMailTemplate(spMailTemplateId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailTemplate deleteSPMailTemplate(
		long spMailTemplateId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSPMailTemplate(spMailTemplateId);
	}
	...
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailTemplate deleteSPMailTemplate(
		com.sambaash.platform.srv.mail.model.SPMailTemplate spMailTemplate)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSPMailTemplate(spMailTemplate);
	}
	...
	*/
	...
	public static com.sambaash.platform.srv.mail.model.SPMailTemplate fetchSPMailTemplate(
		long spMailTemplateId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchSPMailTemplate(spMailTemplateId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailTemplate getSPMailTemplate(
		long spMailTemplateId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getSPMailTemplate(spMailTemplateId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.mail.model.SPMailTemplate> getSPMailTemplates(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSPMailTemplates(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getSPMailTemplatesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSPMailTemplatesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailTemplate updateSPMailTemplate(
		com.sambaash.platform.srv.mail.model.SPMailTemplate spMailTemplate)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSPMailTemplate(spMailTemplate);
	}
	...
	*/
	...
	public static void addCustomSPMailTemplate(
		com.sambaash.platform.srv.mail.model.SPMailTemplate spMailTemplate) {
		getService().addCustomSPMailTemplate(spMailTemplate);
	}
	...
	public static java.util.List<com.sambaash.platform.srv.mail.model.SPMailTemplate> findByparentTempalteId(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByparentTempalteId(parentTempalteId);
	}
	...
	public static com.sambaash.platform.model.MailMessage getMailMessage(
		java.lang.String parameter, long scopeGroupId, boolean hmtlFormat) {
		return getService().getMailMessage(parameter, scopeGroupId, hmtlFormat);
	}
	...
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailTemplate getSPMailTemplate(
		...
		return getService().getSPMailTemplate(parameter, scopeGroupId);
	}

	public static java.util.List<com.sambaash.platform.srv.mail.model.SPMailTemplate> getTemplates()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public static SPMailTemplateLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					SPMailTemplateLocalService.class.getName());

			if (invokableLocalService instanceof SPMailTemplateLocalService) {
				_service = (SPMailTemplateLocalService)invokableLocalService;
			}
			else {
				_service = new SPMailTemplateLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(SPMailTemplateLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(SPMailTemplateLocalService service) {
	}

	private static SPMailTemplateLocalService _service;
}