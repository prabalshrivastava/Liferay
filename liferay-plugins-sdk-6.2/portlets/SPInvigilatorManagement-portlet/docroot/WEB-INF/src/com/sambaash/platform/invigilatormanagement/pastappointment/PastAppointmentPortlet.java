package com.sambaash.platform.invigilatormanagement.pastappointment;
 ...
 */
public class PastAppointmentPortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(PastAppointmentPortlet.class.getName());
