 ...
 * @generated
 */
public abstract class PERuleSetActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PERuleSetActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PERuleSetLocalServiceUtil.getService());
		setClass(PERuleSet.class);

		setClassLoader(com.sambaash.platform.srv.processbuilder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPERuleSetId");
	}
}