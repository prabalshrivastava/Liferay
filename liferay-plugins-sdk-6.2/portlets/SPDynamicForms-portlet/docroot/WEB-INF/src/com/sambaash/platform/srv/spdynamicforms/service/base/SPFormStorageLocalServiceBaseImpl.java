...
import com.sambaash.platform.srv.spdynamicforms.service.SPFormStorageLocalService;
...
/**
 * Provides the base implementation for the s p form storage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.spdynamicforms.service.impl.SPFormStorageLocalServiceImpl}.
 * </p>
 *
 * @author glenn
 ...
 * @generated
 */
public abstract class SPFormStorageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SPFormStorageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.spdynamicforms.service.SPFormStorageLocalServiceUtil} to access the s p form storage local service.
	 */
	...
	@Override
	public SPFormStorage addSPFormStorage(SPFormStorage spFormStorage)
		throws SystemException {
		spFormStorage.setNew(true);

		return spFormStoragePersistence.update(spFormStorage);
	}
	 ...
	 */
	@Override
	public SPFormStorage createSPFormStorage(long formStorageId) {
		return spFormStoragePersistence.create(formStorageId);
	}
	...
	@Override
	public SPFormStorage deleteSPFormStorage(long formStorageId)
		throws PortalException, SystemException {
		return spFormStoragePersistence.remove(formStorageId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SPFormStorage deleteSPFormStorage(SPFormStorage spFormStorage)
		throws SystemException {
		return spFormStoragePersistence.remove(spFormStorage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SPFormStorage.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return spFormStoragePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return spFormStoragePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SPFormStorage fetchSPFormStorage(long formStorageId)
		throws SystemException {
		return spFormStoragePersistence.fetchByPrimaryKey(formStorageId);
	}
	 ...
	 */
	@Override
	public SPFormStorage getSPFormStorage(long formStorageId)
		throws PortalException, SystemException {
		return spFormStoragePersistence.findByPrimaryKey(formStorageId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return spFormStoragePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SPFormStorage> getSPFormStorages(int start, int end)
		throws SystemException {
		return spFormStoragePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSPFormStoragesCount() throws SystemException {
		return spFormStoragePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SPFormStorage updateSPFormStorage(SPFormStorage spFormStorage)
		throws SystemException {
		return spFormStoragePersistence.update(spFormStorage);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.sambaash.platform.srv.spdynamicforms.model.SPFormStorage",
			spFormStorageLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = spFormStoragePersistence.getDataSource();
	...
	private SPFormStorageLocalServiceClpInvoker _clpInvoker = new SPFormStorageLocalServiceClpInvoker();
}