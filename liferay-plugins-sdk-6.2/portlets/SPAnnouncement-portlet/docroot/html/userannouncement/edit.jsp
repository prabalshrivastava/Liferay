...
<div class="subHeader">
	<div class="container">
		...
		<aui:row>
			<aui:col span="10" cssClass="text-center"><h2><span><%= request.getParameter("formTypeName").toUpperCase() %> SETUP</span></h2></aui:col>
...
function validateFormIOForm(thisInstance){
	...
	}else if(formdata.Status == "Active" && startDateEncoded.getTime()  < today.getTime() ){
