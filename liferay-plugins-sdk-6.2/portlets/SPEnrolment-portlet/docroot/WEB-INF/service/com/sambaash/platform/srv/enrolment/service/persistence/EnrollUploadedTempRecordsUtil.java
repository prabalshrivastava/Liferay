...
/**
 * The persistence utility for the enroll uploaded temp records service. This utility wraps {@link EnrollUploadedTempRecordsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class EnrollUploadedTempRecordsUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(enrollUploadedTempRecords);
	}
	 ...
	 */
	public static List<EnrollUploadedTempRecords> findWithDynamicQuery(
	 ...
	 */
	public static EnrollUploadedTempRecords update(
		EnrollUploadedTempRecords enrollUploadedTempRecords)
		throws SystemException {
		return getPersistence().update(enrollUploadedTempRecords);
	}
	...
	public static EnrollUploadedTempRecords update(
		...
		return getPersistence().update(enrollUploadedTempRecords, serviceContext);
	}
	...
	*/
	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords findByUploadTransactId(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords fetchByUploadTransactId(
		java.lang.String uploadTransactId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByUploadTransactId(uploadTransactId);
	}
	...
	*/
	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords fetchByUploadTransactId(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .fetchByUploadTransactId(uploadTransactId, retrieveFromCache);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords removeByUploadTransactId(
		java.lang.String uploadTransactId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.enrolment.NoSuchEnrollUploadedTempRecordsException {
		return getPersistence().removeByUploadTransactId(uploadTransactId);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(enrollUploadedTempRecords);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(enrollUploadedTempRecordses);
	}
	...
	*/
	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords create(
		long uploadedRecId) {
		return getPersistence().create(uploadedRecId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords remove(
		long uploadedRecId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.enrolment.NoSuchEnrollUploadedTempRecordsException {
		return getPersistence().remove(uploadedRecId);
	}

	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords updateImpl(
		com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords enrollUploadedTempRecords)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(enrollUploadedTempRecords);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords findByPrimaryKey(
		long uploadedRecId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.enrolment.NoSuchEnrollUploadedTempRecordsException {
		return getPersistence().findByPrimaryKey(uploadedRecId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords fetchByPrimaryKey(
		long uploadedRecId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(uploadedRecId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.enrolment.model.EnrollUploadedTempRecords> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static EnrollUploadedTempRecordsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (EnrollUploadedTempRecordsPersistence)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.enrolment.service.ClpSerializer.getServletContextName(),
					EnrollUploadedTempRecordsPersistence.class.getName());

			ReferenceRegistry.registerReference(EnrollUploadedTempRecordsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(EnrollUploadedTempRecordsPersistence persistence) {
	}

	private static EnrollUploadedTempRecordsPersistence _persistence;
}