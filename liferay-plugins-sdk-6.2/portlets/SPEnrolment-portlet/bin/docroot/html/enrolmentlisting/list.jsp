		...
		<div id="threedot">
			...
			<div id="popoverId" class="Pop-Action listingPopover hide">
				<ul>
					...
					<% if(PermissionUtil.canEditModel((PortletRequest) request.getAttribute("javax.portlet.request"))){ %>
					<li class="processEnrolment" style="display:none"><img src="/html/images/process-enrolment.svg" alt="Archive"><a
						href="javascript:void(0);" onclick="updateApprovalStatus('Pending Switch Programme')">Submit For Approval</a></li>
						<li class="processEnrolment" style="display:none"><img src="/html/images/process-enrolment.svg" alt="Archive"><a
						href="javascript:void(0);" onclick="updateApprovalStatus('Approved Switch Programme')">Approve</a></li>
						<li class="processEnrolment" style="display:none"><img src="/html/images/process-enrolment.svg" alt="Archive"><a
						href="javascript:void(0);" onclick="updateApprovalStatus('Reject Switch Programme')">Reject</a></li>
					<li class="processEnrolment" style="display:none"><img src="/html/images/process-enrolment.svg" alt="Archive"><a
						href="javascript:void(0);" onclick="processEnrolmentI(this);">Process Enrolment</a></li>
					<li class="switchProgramme" style="display:none"><img src="/html/images/switch.svg" alt="Archive"><a
						href="javascript:void(0);" onclick="switchProgrammeI(this);">Switch Programme</a></li>
					<li class="switchSubjects" style="display:none"><img src="/html/images/switch.svg" alt="Archive"><a
						href="javascript:void(0);" onclick="switchSubjectI(this);">Switch Subjects</a></li>
					<li class="cancelEnrolment" style="display:none"><img src="/html/images/archive.png" alt="Archive"><a
						href="javascript:void(0);" onclick="storageStatus1('Cancelled',this,'<%= switchProgrammeUrl %>');">Cancel Enrolment</a></li>
					<li class="sendNotification"><img src="/html/images/email.svg" alt="Archive"><a
						href="javascript:void(0);" onclick="showNotificationI(this);">Send Enrolment Notification</a></li>
					<li class="withdrawEnrolment" style="display:none"><img src="/html/images/archive.png" alt="Archive"><a
