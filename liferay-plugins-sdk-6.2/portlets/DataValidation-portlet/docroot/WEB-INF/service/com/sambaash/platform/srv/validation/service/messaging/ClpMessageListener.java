...
package com.sambaash.platform.srv.validation.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SPStudentProgrammeLocalServiceUtil.clearService();

			SPStudentProgrammeServiceUtil.clearService();
			SPStudentProgrammeResultLocalServiceUtil.clearService();
		}
	}
}