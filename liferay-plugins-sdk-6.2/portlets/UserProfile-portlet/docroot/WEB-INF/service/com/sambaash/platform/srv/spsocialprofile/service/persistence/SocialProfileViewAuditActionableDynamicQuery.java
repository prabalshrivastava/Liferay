 ...
 * @generated
 */
public abstract class SocialProfileViewAuditActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SocialProfileViewAuditActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(SocialProfileViewAuditLocalServiceUtil.getService());
		setClass(SocialProfileViewAudit.class);

		setClassLoader(com.sambaash.platform.srv.spsocialprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("socialProfileViewAuditId");
	}
}