...
try{
	...
	function init() {
	try{
		loadmore_container = getClosestParentByAttribute(triggered_view_more_button, "data-vnc-loadmore-dom-id", "loadmore-container");

		items_container = getFirstElementsByAttribute(loadmore_container, "ul", "data-vnc-loadmore-dom-id", "items-container");
		loading_status = getLastElementsByAttribute(loadmore_container, "div", "data-vnc-loadmore-dom-id", "loading-status");
		view_more_link_container = getLastElementsByAttribute(loadmore_container, "div", "data-vnc-loadmore-dom-id", "view-more-link-container");
		unshown_status = getLastElementsByAttribute(loadmore_container, "span", "data-vnc-loadmore-dom-id", "unshown-status");
		load_msg = getLastElementsByAttribute(loadmore_container, "div", "data-vnc-loadmore-dom-id", "load-msg");

		loadmore_data = JSON.parse(triggered_view_more_button.getAttribute("data-vnc-loadmore"), "");
	...
	try{
		...
		var loadmore_dom_id = target.getAttribute("data-vnc-loadmore-dom-id");
	...
	try{
		...
		triggered_view_more_button.setAttribute("data-vnc-loadmore", JSON.stringify(loadmore_data, "", ""));
