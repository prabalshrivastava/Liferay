...
/**
 * Provides the local service interface for SPCompetency. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author harini
 * @see SPCompetencyLocalServiceUtil
...
public interface SPCompetencyLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPCompetencyLocalServiceUtil} to access the s p competency local service. Add custom service methods to {@link com.sambaash.platform.srv.extendedprofile.service.impl.SPCompetencyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
