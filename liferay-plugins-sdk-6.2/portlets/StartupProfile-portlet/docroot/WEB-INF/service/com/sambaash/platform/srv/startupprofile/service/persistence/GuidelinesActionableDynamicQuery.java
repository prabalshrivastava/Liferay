 ...
 * @generated
 */
public abstract class GuidelinesActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public GuidelinesActionableDynamicQuery() throws SystemException {
		setBaseLocalService(GuidelinesLocalServiceUtil.getService());
		setClass(Guidelines.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("guidelineId");
	}
}