...
/**
 * Provides the local service interface for SPSellingItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pradeep
 * @see SPSellingItemLocalServiceUtil
...
public interface SPSellingItemLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPSellingItemLocalServiceUtil} to access the s p selling item local service. Add custom service methods to {@link com.sambaash.platform.srv.spshopping.service.impl.SPSellingItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
