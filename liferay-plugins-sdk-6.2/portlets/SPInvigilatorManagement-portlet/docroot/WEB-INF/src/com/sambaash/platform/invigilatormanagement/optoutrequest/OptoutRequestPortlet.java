package com.sambaash.platform.invigilatormanagement.optoutrequest;
...
/**
 * Portlet implementation class OptinoutRequestPortlet
 */
public class OptoutRequestPortlet extends MVCPortlet {
		...
		private Log _log = LogFactoryUtil.getLog(OptoutRequestPortlet.class.getName());
