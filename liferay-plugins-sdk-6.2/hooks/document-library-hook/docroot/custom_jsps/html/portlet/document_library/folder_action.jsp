		...
		<c:if test="<%= showActions %>">
			<c:choose>
				<c:when test="<%= folder != null %>">
					...
					<c:if test="<%= DLFolderPermission.contains(permissionChecker, scopeGroupId, folderId, shareKey) && layout.isPublicLayout() %>">
						<portlet:renderURL var="shareURL">
							<portlet:param name="struts_action" value="/document_library/share_file_entry" />
							<portlet:param name="redirect" value="<%= currentURL %>" />
							<portlet:param name="folderId" value="<%= String.valueOf(folderId) %>" />
						</portlet:renderURL>
