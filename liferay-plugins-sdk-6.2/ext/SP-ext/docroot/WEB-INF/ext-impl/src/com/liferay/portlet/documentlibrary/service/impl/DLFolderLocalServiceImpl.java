...
public class DLFolderLocalServiceImpl extends DLFolderLocalServiceBaseImpl {
	...
	public DLFolder addFolder(
		...
		// Nov 4th 2015 , Naresh - Added below method invocation,it will inherit permissions from parent folder, based on settings specified in portal-ext.properties.
		PermissionUtil.inhertParentPermissions(dlFolder,SambaashConstants.PERMISSION_OPERATION_MERGE,null);
	...
	public void updateLastPostDate(long folderId, Date lastPostDate)
		...
		if (dlFolder.getLastPostDate() != null && lastPostDate.before(dlFolder.getLastPostDate())) {
			return;
		}
