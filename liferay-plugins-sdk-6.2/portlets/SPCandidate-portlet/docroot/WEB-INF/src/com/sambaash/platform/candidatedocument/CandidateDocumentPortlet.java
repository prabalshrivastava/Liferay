package com.sambaash.platform.candidatedocument;
...
import com.sambaash.platform.action.ajax.CheckEmailActionHandler;
...
import com.sambaash.platform.candidate.CandidatePortlet;
import com.sambaash.platform.constant.SystemSetupConstants;

/**
 * Portlet implementation class CandidateDocumentPortlet
 */
public class CandidateDocumentPortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(CandidatePortlet.class.getName());
