								...
								<div class="col-sm-6">
									<div class="form-group formio-component-textfield has-error">
										<label class="control-label">Facility Code  <span
											...
											id="facilityCode" placeholder="Enter Facility Code"
								...
								<div class="col-sm-6">
									<div class="form-group formio-component-textfield has-error">
										<label class="control-label">Location Map URL  <span
											...
											placeholder="Enter Locatio Map Url" onChange="validatevalue();">
											<div class="formio-errors invalid-feedback hide">
												<p class="help-block">Location Map is required</p>
											</div>
									</div>
								</div>
							</div>
										...
										<aui:row>
											<aui:col span="12" cssClass="userAction">
												...
												<button
													...
													type="button" type="button" onClick="goBack()">Go Back</button>
											</aui:col>
										</aui:row>
											...
											<aui:row>
												<aui:col span="12" cssClass="userAction">
													<button
														...
														type="button" onClick="reloadPage()">Start Again</button>
													<button
														class="btn cancel btn-primary popup-cancel pull-right">DashBoard</button>
												</aui:col>
											</aui:row>
								...
								<div id="sucess-popup1" hidden="true" class="modalpopupBox">
									<div id="sucess-popup-box1" class="modalpopupContent">
										<form class="formContainer">
											<aui:row>
												<aui:col span="12">
													<h3 id="success-msg">Facility draft Created!</h3>
												</aui:col>
								...
								<div class="col-sm-12" id="detail_button">
									<div class="col-sm-12 text-center">
										...
										<button type="button" class="btn btn-deactive"
											...
											id="deactive" style="display: none">DEACTIVATE</button>
