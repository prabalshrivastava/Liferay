 ...
 * @generated
 */
public abstract class SPJobRoleActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPJobRoleActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPJobRoleLocalServiceUtil.getService());
		setClass(SPJobRole.class);

		setClassLoader(com.sambaash.platform.srv.extendedprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spJobRoleId");
	}
}