 ...
 * @generated
 */
public abstract class RsvpCoParticipantDetailActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RsvpCoParticipantDetailActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(RsvpCoParticipantDetailLocalServiceUtil.getService());
		setClass(RsvpCoParticipantDetail.class);

		setClassLoader(com.sambaash.platform.srv.rsvp.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("rsvpCoParticipantDetailId");
	}
}