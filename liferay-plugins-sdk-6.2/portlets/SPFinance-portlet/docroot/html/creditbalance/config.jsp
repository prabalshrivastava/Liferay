...
<%
	...
	String creditNotesUrl = renderRequest.getPreferences().getValue("creditNotesUrlPref","");
%>
...
<aui:row cssClass="ps-pref-container" style="margin:10px auto; max-width:640px">
	<aui:col span="12">
		<aui:form name="editPreferences" action="<%=savePreferencesActionURL%>">	
			...
			<aui:input name="creditNotesUrlPref" label="Credit Notes URL" value='<%=creditNotesUrl%>'></aui:input>
			<aui:button-row>
