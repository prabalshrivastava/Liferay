 ...
 * @generated
 */
public abstract class SPTemplateActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPTemplateActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPTemplateLocalServiceUtil.getService());
		setClass(SPTemplate.class);

		setClassLoader(com.sambaash.platform.srv.template.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spTemplateId");
	}
}