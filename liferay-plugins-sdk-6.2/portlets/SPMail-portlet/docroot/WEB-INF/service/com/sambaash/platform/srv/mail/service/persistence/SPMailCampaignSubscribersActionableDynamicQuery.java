 ...
 * @generated
 */
public abstract class SPMailCampaignSubscribersActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPMailCampaignSubscribersActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(SPMailCampaignSubscribersLocalServiceUtil.getService());
		setClass(SPMailCampaignSubscribers.class);

		setClassLoader(com.sambaash.platform.srv.mail.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spMailCampaignSubscribersId");
	}
}