package com.sambaash.platform.schedulefacilitylinking;
...
import com.sambaash.platform.action.ajax.FetchEntityActionHandler;
...
import com.sambaash.platform.schedulelinking.ScheduleLinkingPortlet;
import com.sambaash.platform.action.ajax.CreateActionHandler;
import com.sambaash.platform.action.ajax.ElasticSearchListActionHandler;

/**
 * Portlet implementation class ScheduleFacilityLinking
 */
public class ScheduleFacilityLinking extends MVCPortlet {
	 ...
	 */
	private Log log = LogFactoryUtil.getLog(ScheduleLinkingPortlet.class.getName());
