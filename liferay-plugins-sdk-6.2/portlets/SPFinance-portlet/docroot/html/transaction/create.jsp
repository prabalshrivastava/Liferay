			...
			<div class="inner-container">
				<aui:row>
					<aui:col span="10" cssClass="text-center">
						<h2>
							<span style="text-transform: none;">Adhoc / Misc Fees Invoicing</span>
						</h2>
					</aui:col>
				...
				<div class="formContainer container formio-form"
					...
					<form class="aui" id="invoiceForm" name="invoiceForm" action="">
						...
						<div id="payment-section"
							...
							<aui:row>
								...
								<aui:col span="6">
									<label id="totalFee" cssClass="control-label"
										style="text-align: right !important;"></label>
								</aui:col>
							</aui:row>
							<aui:row>
								<aui:col span="6">
							...
							<aui:row>
								<aui:col span="6">
									<label cssClass="control-label">TOTAL INVOICE AMOUNT</label>
								</aui:col>
								<aui:col span="6">
