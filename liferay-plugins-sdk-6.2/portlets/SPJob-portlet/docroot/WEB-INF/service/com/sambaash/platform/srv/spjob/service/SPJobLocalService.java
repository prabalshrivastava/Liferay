...
/**
 * Provides the local service interface for SPJob. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author harini
 * @see SPJobLocalServiceUtil
...
public interface SPJobLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPJobLocalServiceUtil} to access the s p job local service. Add custom service methods to {@link com.sambaash.platform.srv.spjob.service.impl.SPJobLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
