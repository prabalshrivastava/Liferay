...
String vm = PortalUtil.getOriginalServletRequest(r).getParameter("_vm"); 
%>
				...
				<div class="w-95 mx-auto">
					...
					<div id="fee-container" class="mt-5">
						<div id="standardFeeToggler">
							...
							<div class="standardFeeContent toggler-content-expanded " style="display: none;">
					...
					<div class="enrolment-center-align py-5">
						<div class="button-holder userAction text-center"> 
	                        <aui:button type="button" cssClass="draftBtn" onclick="saveDraft()" value="SAVE DRAFT" />
...
YUI().use("aui-toggler", function(Y) {
  new Y.TogglerDelegate({
	...
	function submitForApproval(value) {
