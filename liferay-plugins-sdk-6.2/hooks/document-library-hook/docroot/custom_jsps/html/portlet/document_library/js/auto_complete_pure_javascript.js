function AutoComplete(param) {
	...
	try{	
		...
		var si_html = "<li data-autocomplete-dom-id=\"si\" class=\"ip-si sp-group-maxs\"><div class=\"sp-group-clearfix\"><div class=\"sp-group-lfloat sp-group-mrm\" style=\"line-height: 0;\"><img data-autocomplete-dom-id=\"si-img\" src=\"\" class=\"sp-group-thumb_32\" alt=\"autoComplete\" /></div><div class=\"sp-group-ui-dib\"><div class=\"sp-group-ui-dib sp-group-ui-vam\" style=\"height:32px;\"></div><div class=\"sp-group-ui-dib sp-group-ui-vam\"><span data-autocomplete-dom-id=\"si-name\"></span>(<span userIdCheck=\"userId\" data-autocomplete-dom-id=\"si-email\"></span>)</div></div>"
			+ "<div class=\"sp-group-ui-dib\"><div class=\"sp-group-ui-dib sp-group-ui-vam\" style=\"height:32px;\"></div><div class=\"sp-group-ui-dib sp-group-ui-vam\"><input name=\"iAllowWrite\" type=\"checkbox\">" +  writeAccess + "</input></div></div>"
		...
		if(emailExists == false){
			...
			daysDiv.setAttribute("class","shareSelect");
	  		daysDiv.setAttribute("name","iShareDuration");
			...
			var durationNode = getFirstElementsByAttribute(si, "span", "data-autocomplete-dom-id", "si-duration");
	...
	try{	
		var si_html = "<li emailCheck=\"email\" data-autocomplete-dom-id=\"si\" class=\"ip-si sp-group-maxs\"><div class=\"sp-group-clearfix\"><div class=\"sp-group-lfloat sp-group-mrm\" style=\"line-height: 0;\"><img data-autocomplete-dom-id=\"si-img\" src=\"/SPGroup-portlet/images/send_by_email.png\" class=\"sp-group-thumb_32\" alt=\"autoComplete\" /></div><div class=\"sp-group-ui-dib\"><div class=\"sp-group-ui-dib sp-group-ui-vam\" style=\"height:32px;\"></div><div class=\"sp-group-ui-dib sp-group-ui-vam\"><span data-autocomplete-dom-id=\"si-email\"></span></div></div> " 
			+ "<div class=\"sp-group-ui-dib\"><div class=\"sp-group-ui-dib sp-group-ui-vam\" style=\"height:32px;\"></div><div class=\"sp-group-ui-dib sp-group-ui-vam\"><input name=\"iAllowWrite\" type=\"checkbox\">" +  allowWrite + "</input></div></div>" 
			 + "<div style=\"float:right\"><div style=\"margin-left:10px\" class=\"sp-group-ui-dib sp-group-ui-vam\"><span data-autocomplete-dom-id=\"si-duration\"></span></div><div class=\"sp-group-ui-dib sp-group-ui-vam\"><span  data-autocomplete-dom-id=\"si-x\" class=\"ip-si-x sp-group-mlm sp-group-mrs\">X</span></div></div></div></li>";
		...
		if (!filter.test(email)) {
	        alert( notValidEmail);
	        that.j_autocomplete_input.value = "";
	    }else if(emailDomain != "noFiltering" && emailDomain != ""){
	    	if(email.indexOf(emailDomain)> -1){
	...
	try{
    	...
    	if(input_vaule.length > 0) {
    		...
    		var temp_url = find_suggestions_url + "&" + portlet_namespace + "group_id=" + group_id + "&" + portlet_namespace + "q=" + input_value + "&" + portlet_namespace + "invite_by=" + invite_by +"&" + portlet_namespace + "sharedTypeToGetUserList=internalShare";
