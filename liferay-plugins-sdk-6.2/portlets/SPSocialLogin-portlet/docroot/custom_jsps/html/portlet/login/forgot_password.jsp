...
%>
<section class="sp-social-login-wrap forgot-password">
							...
							<div class="sp-social-login-section sp-social-login-section-left inline-block align-top font-std">
								<div class="sl-login-wrap">
									<div class="sl-login-content">
										...
										<aui:form action="<%= forgotPasswordURL %>" method="post" name="fm" autocomplete="off">
											...
											<liferay-ui:error exception="<%= com.liferay.portlet.login.action.PasswordResetInternalUserException.class %>" message="forgot.password.not.applicable.internal.user" />
											<aui:fieldset>
												<c:choose>
