package com.sambaash.platform.invigilatormanagement.updateinvigilationdates;
 ...
 */
public class UpdateinvigilationDatePortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(UpdateinvigilationDatePortlet.class.getName());
    ...
    public void savePreferences(ActionRequest actionRequest,
		...
		try {
			...
			preferences.setValue("toDate", toDate);
			preferences.store();			
