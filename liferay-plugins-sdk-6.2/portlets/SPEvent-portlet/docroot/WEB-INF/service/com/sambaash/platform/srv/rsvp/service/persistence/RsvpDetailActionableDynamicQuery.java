 ...
 * @generated
 */
public abstract class RsvpDetailActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RsvpDetailActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RsvpDetailLocalServiceUtil.getService());
		setClass(RsvpDetail.class);

		setClassLoader(com.sambaash.platform.srv.rsvp.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("rsvpDetailId");
	}
}