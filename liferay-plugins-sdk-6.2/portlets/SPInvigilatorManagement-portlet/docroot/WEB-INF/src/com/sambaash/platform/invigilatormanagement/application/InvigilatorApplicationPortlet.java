package com.sambaash.platform.invigilatormanagement.application;
...
import com.sambaash.platform.invigilatormanagement.action.ajax.NotifyInvigilatorActionHandler;
 ...
 */
public class InvigilatorApplicationPortlet extends MVCPortlet {
	...
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("notifyInvigilator", NotifyInvigilatorActionHandler.class);
	}
	/**
	...
	public void savePreferences(ActionRequest actionRequest, ActionResponse actionResponse) {
		...
		String submitClaimUrl = ParamUtil.getString(actionRequest, "submitClaimUrlPref", "");
		try {
			...
			preferences.setValue("submitClaimUrlPref", submitClaimUrl);
			preferences.store();
