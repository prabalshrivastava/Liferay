...
/**
 * Provides the local service interface for SPMailLinkTracking. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see SPMailLinkTrackingLocalServiceUtil
...
public interface SPMailLinkTrackingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPMailLinkTrackingLocalServiceUtil} to access the s p mail link tracking local service. Add custom service methods to {@link com.sambaash.platform.srv.mail.service.impl.SPMailLinkTrackingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
