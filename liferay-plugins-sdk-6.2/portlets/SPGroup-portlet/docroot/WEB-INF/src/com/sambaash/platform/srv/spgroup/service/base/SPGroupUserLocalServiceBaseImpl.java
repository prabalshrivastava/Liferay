...
import com.sambaash.platform.srv.spgroup.service.SPGroupUserLocalService;
...
/**
 * Provides the base implementation for the s p group user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.spgroup.service.impl.SPGroupUserLocalServiceImpl}.
 * </p>
 *
 * @author harini
 * @see com.sambaash.platform.srv.spgroup.service.impl.SPGroupUserLocalServiceImpl
 * @see com.sambaash.platform.srv.spgroup.service.SPGroupUserLocalServiceUtil
 * @generated
 */
public abstract class SPGroupUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SPGroupUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.spgroup.service.SPGroupUserLocalServiceUtil} to access the s p group user local service.
	 */
	...
	@Override
	public SPGroupUser addSPGroupUser(SPGroupUser spGroupUser)
		throws SystemException {
		spGroupUser.setNew(true);

		return spGroupUserPersistence.update(spGroupUser);
	}
	 ...
	 */
	@Override
	public SPGroupUser createSPGroupUser(SPGroupUserPK spGroupUserPK) {
		return spGroupUserPersistence.create(spGroupUserPK);
	}
	...
	@Override
	public SPGroupUser deleteSPGroupUser(SPGroupUserPK spGroupUserPK)
		throws PortalException, SystemException {
		return spGroupUserPersistence.remove(spGroupUserPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SPGroupUser deleteSPGroupUser(SPGroupUser spGroupUser)
		throws SystemException {
		return spGroupUserPersistence.remove(spGroupUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SPGroupUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return spGroupUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return spGroupUserPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return spGroupUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SPGroupUser fetchSPGroupUser(SPGroupUserPK spGroupUserPK)
		throws SystemException {
		return spGroupUserPersistence.fetchByPrimaryKey(spGroupUserPK);
	}
	 ...
	 */
	@Override
	public SPGroupUser getSPGroupUser(SPGroupUserPK spGroupUserPK)
		throws PortalException, SystemException {
		return spGroupUserPersistence.findByPrimaryKey(spGroupUserPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return spGroupUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SPGroupUser> getSPGroupUsers(int start, int end)
		throws SystemException {
		return spGroupUserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSPGroupUsersCount() throws SystemException {
		return spGroupUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SPGroupUser updateSPGroupUser(SPGroupUser spGroupUser)
		throws SystemException {
		return spGroupUserPersistence.update(spGroupUser);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.sambaash.platform.srv.spgroup.model.SPGroupUser",
			spGroupUserLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = spGroupUserPersistence.getDataSource();
	...
	private SPGroupUserLocalServiceClpInvoker _clpInvoker = new SPGroupUserLocalServiceClpInvoker();
}