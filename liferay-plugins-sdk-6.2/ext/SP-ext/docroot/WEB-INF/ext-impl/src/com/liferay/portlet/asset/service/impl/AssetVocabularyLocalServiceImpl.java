...
public class AssetVocabularyLocalServiceImpl
	...
	private static Log _log = LogFactoryUtil.getLog(AssetVocabularyLocalServiceImpl.class);
	...
	public List<AssetVocabulary> getGroupVocabularies(
		...
		if (_log.isDebugEnabled()) {
			_log.debug("groupId : " + groupId + " : addDefaultVocabulary : " + addDefaultVocabulary
					+ " : vocabularies.size() : " + vocabularies.size());
		}
	...
	protected void validate(long groupId, String name)
		...
		if (hasVocabulary(groupId, name)) {
			throw new DuplicateVocabularyException(
				"A category vocabulary with the group id " + groupId + " and name " + name +
					" already exists");
		}
	}
