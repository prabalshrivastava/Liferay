...
/**
 * Provides the local service interface for SPVoting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author harini
 * @see SPVotingLocalServiceUtil
...
public interface SPVotingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPVotingLocalServiceUtil} to access the s p voting local service. Add custom service methods to {@link com.sambaash.platform.srv.spvoting.service.impl.SPVotingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
