 ...
 * @generated
 */
public abstract class SPChallengeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPChallengeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPChallengeLocalServiceUtil.getService());
		setClass(SPChallenge.class);

		setClassLoader(com.sambaash.platform.srv.spchallenge.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spChallengeId");
	}
}