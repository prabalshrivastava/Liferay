package com.sambaash.platform.systemmodelsetup.holidaycalendar;
...
import com.sambaash.platform.systemmodelsetup.holidaycalendar.HolidayCalendarPortlet;

/**
 * Portlet implementation class HolidayCalendarPortlet
 */
public class HolidayCalendarPortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(HolidayCalendarPortlet.class.getName());
    ...
    public void savePreferences(ActionRequest actionRequest,
		...
		} catch (ReadOnlyException | PortletModeException | ValidatorException | IOException e) {
			log.error(e);
		}
