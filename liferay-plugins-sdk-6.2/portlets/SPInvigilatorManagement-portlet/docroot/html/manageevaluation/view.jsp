		...
		<div class="col-sm-12">
				...
				<div class="col-sm-6">
				  <div class="form-group has-error">
					<div class="form-group choices formio-choices">
						...
						<select class="form-control facilityCategory" id="appointmentType">
		   ...
		   <div class="col-sm-12">
			...
			<div class="row userAction">
					...
					<button type="button"  id="bt_submit" onclick="openEditPage()"  class="btn btn-primary">EDIT</button>
...
function getInvigilator(code) {
	...
	ajaxCallAPI('GET', 'elastiSearchList', invigilatorData, function () {
		...
		if(selectedInvigilator){
			document.getElementById("invigilator").value = selectedInvigilator;
		}
	...
	if (formStorageId != "") {
		...
		ajaxCallAPI('GET', "loadData", data, function () {
			...
			if (data.error) {
				...
				if(!isInvigilatorAdmin && jsondata.submittedByAdmin ){
					alert("Already reviewed by Invigilator Admin");
					window.location.href = dashboardLinkk;
				}else{
					document.getElementById("schedule").value = contentdata.contentJson.ScheduleCode;
					selectedInvigilator =  contentdata.contentJson.InvigilatorCode;
					document.getElementById("invigilator").value = selectedInvigilator;
					...
					var scheduleCode = jsondata.ScheduleCode;
					selectedInvigilator = jsondata.InvigilatorCode;
					getInvigilator(scheduleCode);
					//Evaluation
...
function submitForm(e) {
	...
	if (selected_1 >= 1 && selected_2 >= 1 && selected_3 >= 1) {
		mode = "edit"
		var _data = {};
		_data.formStorageId = formStorageId;
