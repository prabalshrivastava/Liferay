 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.saml.model.SamlSpAuthRequestModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link SamlSpAuthRequestImpl}.
 * </p>
 *
...
public class SamlSpAuthRequestModelImpl extends BaseModelImpl<SamlSpAuthRequest>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a saml sp auth request model instance should use the {@link com.liferay.saml.model.SamlSpAuthRequest} interface instead.
	 */
	...
	public static final String TABLE_SQL_CREATE = "create table SamlSpAuthRequest (samlSpAuthnRequestId BIGINT(20) not null primary key,companyId BIGINT(20),groupId BIGINT(20),createDate DATETIME null,samlIdpEntityId VARCHAR(1024) null,samlSpAuthRequestKey VARCHAR(75) null)";
	...
	public Object clone() {
		...
		samlSpAuthRequestImpl.setGroupId(getGroupId());
	...
	public CacheModel<SamlSpAuthRequest> toCacheModel() {
		...
		samlSpAuthRequestCacheModel.groupId = getGroupId();
