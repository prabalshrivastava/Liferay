...
<head>
	...
	<title>${the_title} - SEAMEO RELC</title>
	...
	<link rel="stylesheet" href="${themeDisplay.getPathThemeCss()}/sp/sp_custom.css?minifierType=css&modified=1565793669" />
	...
	<header class="main-header fixed block pin-left pin-right pin-top  full-width " id="banner" role="banner">
			...
			<div class=" block full-width relative" id="heading">
				...
				<div class="site-main-logo absolute pin-top-left inline-block ">
					<a class="${logo_css_class}" href="${site_default_url}" title="Back to Homepage">
						<img src="${themeDisplay.getPathThemeImages()}/menu/relc-logo.png" alt="logo" class="blackLogo">
					</a>
				...
				<div class="header-content text-right">
						...
						<#if has_navigation>
							...
							<div class="signInheaderSearch">
			                  	<div class="signInsearchBtn" id="signInsearchBtn"></div>
				                     <div class="dropdown-signInsearch" id="dropdown-signInsearch">
				                     	<div class="dropDownContainer">
					                     	<select id="_ftsPageList" class="searchCatgSelect searchFields">
					                     	</select>

					                        <input id="_ftsText" type="text" placeholder="" id="signIn-headerSearchField" class="searchFields">
					                        <div class="signIn_search_icon searchFields">
												<img alt="Search" src="${themeDisplay.getPathThemeImages()}/menu/dsktopsearch.svg" id="_ftsButton" >
											</div>
										</div>
			                    </div>
			                 </div>
					...
					<#if samUtil.isShowSignIn(themeDisplay)>
						<div class="user-dropdown">
	                  <div class="dropbtn" id="user-dropdown-dropbtn"></div>
	                    <div class="dropdown-content-dsktop searchContainer" id="dropdown-content-dsktop">
	                        <#if is_signed_in>
	                         <a href="/profile" class="userDetail"><div class="userDetailIcon"><img src="${themeDisplay.getUser().getPortraitURL(themeDisplay)}"><span>${themeDisplay.getUser().getFirstName()}</span></div></a>
	                         <a href="/profile"><div class="profile"></div><span>Account</span></a>
...
<script>
	...
	var dashboardLinkk = "${samUtil.getDashBoard()}";
...
<div class="loadingDivCommon" id="loadingDivCommon" style="display: none;"> <div class="m-blockui" style="position: fixed; z-index: 1031; left: 50%; top: 50%;"> <span>Please Wait</span> <span> <div class="m-loader m-loader--brand"></div> </span> </div> </div>
</body>
