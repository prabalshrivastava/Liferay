...
import com.sambaash.platform.srv.spdashboard.service.SPAnalyticsConfigService;
import com.sambaash.platform.srv.spdashboard.service.persistence.SPAnalyticsConfigPersistence;

import javax.sql.DataSource;

/**
 * Provides the base implementation for the s p analytics config remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.spdashboard.service.impl.SPAnalyticsConfigServiceImpl}.
 * </p>
 *
 * @author pradeep
 ...
 * @generated
 */
public abstract class SPAnalyticsConfigServiceBaseImpl extends BaseServiceImpl
	implements SPAnalyticsConfigService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.spdashboard.service.SPAnalyticsConfigServiceUtil} to access the s p analytics config remote service.
	 */
	...
	/**
	 * Returns the s p analytics config remote service.
	 *
	 * @return the s p analytics config remote service
	 */
	public com.sambaash.platform.srv.spdashboard.service.SPAnalyticsConfigService getSPAnalyticsConfigService() {
		return spAnalyticsConfigService;
	}

	/**
	 * Sets the s p analytics config remote service.
	 *
	 * @param spAnalyticsConfigService the s p analytics config remote service
	 */
	public void setSPAnalyticsConfigService(
		com.sambaash.platform.srv.spdashboard.service.SPAnalyticsConfigService spAnalyticsConfigService) {
		this.spAnalyticsConfigService = spAnalyticsConfigService;
	}
	...
	@BeanReference(type = com.sambaash.platform.srv.spdashboard.service.SPAnalyticsConfigService.class)
	protected com.sambaash.platform.srv.spdashboard.service.SPAnalyticsConfigService spAnalyticsConfigService;
	...
	private SPAnalyticsConfigServiceClpInvoker _clpInvoker = new SPAnalyticsConfigServiceClpInvoker();
}