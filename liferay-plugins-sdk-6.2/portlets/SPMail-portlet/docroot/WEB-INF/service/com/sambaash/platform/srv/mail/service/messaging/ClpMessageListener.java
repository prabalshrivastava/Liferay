...
package com.sambaash.platform.srv.mail.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SPEMailAuditLocalServiceUtil.clearService();

			SPMailLocalServiceUtil.clearService();

			SPMailBlackListLocalServiceUtil.clearService();

			SPMailCampaignLocalServiceUtil.clearService();

			SPMailCampaignEDMLocalServiceUtil.clearService();

			SPMailCampaignSubscribersLocalServiceUtil.clearService();

			SPMailLinkTrackingLocalServiceUtil.clearService();

			SPMailSubscriberUserAgentLocalServiceUtil.clearService();

			SPMailTemplateLocalServiceUtil.clearService();

			SPMailTemplateServiceUtil.clearService();
			SPMailTemplateAttachmentLocalServiceUtil.clearService();

			SPMailUnsubscribeLocalServiceUtil.clearService();
		}
	}
}