...
/**
 * The persistence utility for the course learning service. This utility wraps {@link CourseLearningPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class CourseLearningUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(CourseLearning courseLearning) {
		getPersistence().clearCache(courseLearning);
	}
	 ...
	 */
	public static List<CourseLearning> findWithDynamicQuery(
	 ...
	 */
	public static CourseLearning update(CourseLearning courseLearning)
		throws SystemException {
		return getPersistence().update(courseLearning);
	}
	...
	public static CourseLearning update(CourseLearning courseLearning,
		...
		return getPersistence().update(courseLearning, serviceContext);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.CourseLearning fetchByCourseId(
		long spCourseId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.CourseLearning removeByCourseId(
		long spCourseId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.NoSuchCourseLearningException {
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(courseLearning);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(courseLearnings);
	}
	...
	*/
	public static com.sambaash.platform.srv.model.CourseLearning create(
		...
		return getPersistence().create(spCourseLearningId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.CourseLearning remove(
		long spCourseLearningId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.NoSuchCourseLearningException {
		return getPersistence().remove(spCourseLearningId);
	}

	public static com.sambaash.platform.srv.model.CourseLearning updateImpl(
		com.sambaash.platform.srv.model.CourseLearning courseLearning)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(courseLearning);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.CourseLearning findByPrimaryKey(
		long spCourseLearningId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.NoSuchCourseLearningException {
		return getPersistence().findByPrimaryKey(spCourseLearningId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.CourseLearning fetchByPrimaryKey(
		long spCourseLearningId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(spCourseLearningId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.model.CourseLearning> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CourseLearningPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CourseLearningPersistence)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.service.ClpSerializer.getServletContextName(),
					CourseLearningPersistence.class.getName());

			ReferenceRegistry.registerReference(CourseLearningUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(CourseLearningPersistence persistence) {
	}

	private static CourseLearningPersistence _persistence;
}