...
/**
 * The persistence utility for the s p cart service. This utility wraps {@link SPCartPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SPCartUtil {
	 ...
	 */
	public static void clearCache(SPCart spCart) {
		getPersistence().clearCache(spCart);
	}
	 ...
	 */
	public static List<SPCart> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static SPCart update(SPCart spCart) throws SystemException {
		return getPersistence().update(spCart);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static SPCart update(SPCart spCart, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(spCart, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(spCart);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(spCarts);
	}
	...
	*/
	public static com.sambaash.platform.srv.spshopping.model.SPCart create(
		long spCartId) {
		return getPersistence().create(spCartId);
	}
	...
	*/
	public static com.sambaash.platform.srv.spshopping.model.SPCart remove(
		long spCartId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.spshopping.NoSuchSPCartException {
		return getPersistence().remove(spCartId);
	}

	public static com.sambaash.platform.srv.spshopping.model.SPCart updateImpl(
		com.sambaash.platform.srv.spshopping.model.SPCart spCart)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(spCart);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spshopping.model.SPCart findByPrimaryKey(
		long spCartId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.spshopping.NoSuchSPCartException {
		return getPersistence().findByPrimaryKey(spCartId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spshopping.model.SPCart fetchByPrimaryKey(
		long spCartId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(spCartId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.spshopping.model.SPCart> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static SPCartPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SPCartPersistence)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.spshopping.service.ClpSerializer.getServletContextName(),
					SPCartPersistence.class.getName());

			ReferenceRegistry.registerReference(SPCartUtil.class, "_persistence");
		}
	 ...
	 */
	public void setPersistence(SPCartPersistence persistence) {
	}

	private static SPCartPersistence _persistence;
}