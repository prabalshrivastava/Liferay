package com.sambaash.platform.result.action;
...
import com.sambaash.platform.action.ajax.ExportPdfActionHandler;
import com.sambaash.platform.constant.SystemSetupConstants;

/**
 * Portlet implementation class CandidateResultPortlet
 */
public class CandidateResultPortlet extends MVCPortlet {
 


	 
	private static final ServeResourceActionManager SERVE_RESOURCE_MANAGER;
	static {SERVE_RESOURCE_MANAGER = new DefaultServeResourceManager();
	 ...
	 */
	private Log log = LogFactoryUtil.getLog(AwardTypePortlet.class.getName());
