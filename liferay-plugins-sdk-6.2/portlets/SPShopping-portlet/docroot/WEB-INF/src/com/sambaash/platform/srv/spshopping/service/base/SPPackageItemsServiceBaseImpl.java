...
import com.sambaash.platform.srv.spshopping.service.SPPackageItemsService;
...
/**
 * Provides the base implementation for the s p package items remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.spshopping.service.impl.SPPackageItemsServiceImpl}.
 * </p>
 *
 * @author pradeep
 ...
 * @generated
 */
public abstract class SPPackageItemsServiceBaseImpl extends BaseServiceImpl
	implements SPPackageItemsService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.spshopping.service.SPPackageItemsServiceUtil} to access the s p package items remote service.
	 */
	...
	/**
	 * Returns the s p package items remote service.
	 *
	 * @return the s p package items remote service
	 */
	public com.sambaash.platform.srv.spshopping.service.SPPackageItemsService getSPPackageItemsService() {
		return spPackageItemsService;
	}

	/**
	 * Sets the s p package items remote service.
	 *
	 * @param spPackageItemsService the s p package items remote service
	 */
	public void setSPPackageItemsService(
		com.sambaash.platform.srv.spshopping.service.SPPackageItemsService spPackageItemsService) {
		this.spPackageItemsService = spPackageItemsService;
	}
	...
	@BeanReference(type = com.sambaash.platform.srv.spshopping.service.SPPackageItemsService.class)
	protected com.sambaash.platform.srv.spshopping.service.SPPackageItemsService spPackageItemsService;
	...
	private SPPackageItemsServiceClpInvoker _clpInvoker = new SPPackageItemsServiceClpInvoker();
}