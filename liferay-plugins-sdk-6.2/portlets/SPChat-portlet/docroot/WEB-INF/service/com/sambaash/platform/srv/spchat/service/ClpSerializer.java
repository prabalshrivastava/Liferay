...
import com.sambaash.platform.srv.spchat.model.EntryClp;
import com.sambaash.platform.srv.spchat.model.StatusClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"SPChat-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "SPChat-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.sambaash.platform.srv.spchat.model.impl.EntryImpl")) {
		...
		if (oldModelClassName.equals(
					"com.sambaash.platform.srv.spchat.model.impl.StatusImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new com.sambaash.platform.srv.spchat.NoSuchEntryException();
		}

		if (className.equals(
					"com.sambaash.platform.srv.spchat.NoSuchStatusException")) {
			return new com.sambaash.platform.srv.spchat.NoSuchStatusException();
		}
