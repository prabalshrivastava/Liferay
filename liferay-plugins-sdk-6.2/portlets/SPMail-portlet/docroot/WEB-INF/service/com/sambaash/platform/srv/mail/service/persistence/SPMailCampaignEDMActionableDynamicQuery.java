 ...
 * @generated
 */
public abstract class SPMailCampaignEDMActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPMailCampaignEDMActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPMailCampaignEDMLocalServiceUtil.getService());
		setClass(SPMailCampaignEDM.class);

		setClassLoader(com.sambaash.platform.srv.mail.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spMailCampaignEDMId");
	}
}