...
<portlet:renderURL var="Announcement">
	<portlet:param name="jspPage"
		value="/html/announcement/list.jsp" />
</portlet:renderURL>
<div class="newPortlets">

<% if(PermissionUtil.canAddModel((PortletRequest) request.getAttribute("javax.portlet.request"))){ %>
<%
String formId = portletPreferences.getValue(SystemSetupConstants.PREF_HTML_FORM_ID, "1899");
...
<div class="subHeader">
	...
	<div class="inner-container">
		<aui:row>
			<aui:col span="10" cssClass="text-center"><h2><span>ANNOUNCEMENT SETUP</span></h2></aui:col>
...
var ajaxUrl = "http://localhost:8081/api/jsonws/SPEnquiryCommon-portlet.fetch/get-favourites";
		...
		A.io.request(ajaxUrl,{
	        ...
	        on : {
	            success : function(){
	            	...
	            	thisInstance.components.TargetAudience.setItems(response);
