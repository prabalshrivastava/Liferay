...
public class ElasticSearchListActionHandler implements ServeResourceActionHandler {
	...
	public void handle(ResourceRequest request, ResourceResponse response) {
		try {
			String modelData = SPResultLocalServiceUtil.getElasticSearchListing(request, response);
			SPResultLocalServiceUtil.saveExportQuery("elasticsearch", modelData, request);
