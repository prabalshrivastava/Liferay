...
package com.sambaash.platform.srv.spsocialprofile.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ExamBodyUserLocalServiceUtil.clearService();

			SocialProfileLocalServiceUtil.clearService();

			SocialProfileServiceUtil.clearService();
			SocialProfileDetailLocalServiceUtil.clearService();

			SocialProfileFriendsLocalServiceUtil.clearService();

			SocialProfileLikeLocalServiceUtil.clearService();

			SocialProfilePullAuditLocalServiceUtil.clearService();

			SocialProfileViewAuditLocalServiceUtil.clearService();

			UserAvailabilityCalendarLocalServiceUtil.clearService();
		}
	}
}