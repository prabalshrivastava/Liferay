 ...
 * @generated
 */
public abstract class SPJobActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPJobActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPJobLocalServiceUtil.getService());
		setClass(SPJob.class);

		setClassLoader(com.sambaash.platform.srv.spjob.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spJobId");
	}
}