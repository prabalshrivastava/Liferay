...
/**
 * Provides the local service interface for SPStudentProgramme. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see SPStudentProgrammeLocalServiceUtil
...
public interface SPStudentProgrammeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPStudentProgrammeLocalServiceUtil} to access the s p student programme local service. Add custom service methods to {@link com.sambaash.platform.srv.validation.service.impl.SPStudentProgrammeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
