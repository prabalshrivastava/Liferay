package com.sambaash.platform.systemmodelsetup.taxcode;
...
import com.sambaash.platform.systemmodelsetup.action.ajax.SendRequestActionHandler;

/**
 * Portlet implementation class TaxCodePortlet
 */
public class TaxCodePortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(TaxCodePortlet.class.getName());
