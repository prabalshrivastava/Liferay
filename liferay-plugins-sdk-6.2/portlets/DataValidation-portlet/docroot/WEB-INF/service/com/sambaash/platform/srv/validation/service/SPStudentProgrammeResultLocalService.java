...
/**
 * Provides the local service interface for SPStudentProgrammeResult. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see SPStudentProgrammeResultLocalServiceUtil
...
public interface SPStudentProgrammeResultLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPStudentProgrammeResultLocalServiceUtil} to access the s p student programme result local service. Add custom service methods to {@link com.sambaash.platform.srv.validation.service.impl.SPStudentProgrammeResultLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
