package com.sambaash.platform.certificate;
...
import com.sambaash.platform.certificate.ajax.CreateActionHandler;
import com.sambaash.platform.certificate.ajax.ElasticSearchListActionHandler;
import com.sambaash.platform.certificate.ajax.ExportListActionHandler;
import com.sambaash.platform.certificate.ajax.ExportRowActionHandler;
import com.sambaash.platform.certificate.ajax.FetchActionHandler;
import com.sambaash.platform.certificate.ajax.FetchFormFieldsActionHandler;
import com.sambaash.platform.certificate.ajax.FileDownloadActionHandler;
import com.sambaash.platform.certificate.ajax.FilterColumnListActionHandler;
import com.sambaash.platform.certificate.ajax.LoadListActionHandler;
import com.sambaash.platform.certificate.ajax.ScannedDataActionHandler;
import com.sambaash.platform.certificate.ajax.SearchListActionHandler;
import com.sambaash.platform.constant.SystemSetupConstants;

/**
 * Portlet implementation class CertificateCollection
 */
public class CertificateCollection extends MVCPortlet {
	 ...
	 */
	private Log log = LogFactoryUtil.getLog(CertificateCollection.class.getName());
