...
function afterFormLoadedFormIOForm(thisInstance){
	...
	formInstance.components.Disclaimer.component.value =true;
	console.log(formInstance.components.Disclaimer);
	formInstance.components.Disclaimer.disabled =true;
...
function checkIsValide(){
	...
	if (formInstance.form.submission.data.ScheduleID == "") {
		...
		eValid = false;
	}else if (!formInstance.form.submission.data.Disclaimer) {
		eValid = false;
	}
	return eValid;
}
