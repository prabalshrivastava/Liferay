...
<%
	...
	//String vocabularyURL = "/api/jsonws/SPPricingEngine-portlet.spdiscountpromo/get-categories/vocabulary-name/Discount%20Promocode%20Categories/group-id/21424";
					...
					<aui:col span="10" cssClass="offset1">
							...
							<aui:col span="12" cssClass="choices formio-choices">
								<div class="form-group">
									<label cssClass="control-label">Promotion / Discount
										Category <span class="red-star">*</span></label>
										...
										<div class="discountPeriodContainer" id="discountPriceBase"
											...
											<h3 class="header toggler-header-collapsed" style="position: relative;top: 0;">
												...
												<ul class="nav">
													<li><a href="javascript:void(0);"
														class="btn removeBtn" onclick="RemoveDiscountPeriod(this)">Remove</a></li>
												</ul>
											</h3>
											...
											<div
												...
												<aui:row>
													...
													<aui:row>
														<aui:col span="6" cssClass="formio-component-textfield">
														<label cssClass="control-label">Discount Type <span class="red-star">*</span></label>
															<aui:select name="" id="discountType"
														...
														<aui:col span="6">
														<label cssClass="control-label">Value <span class="red-star">*</span></label>
											...
											<div
												...
												<aui:row>
													<aui:row>
														<aui:col span="12">
															<div class="form-group">
																<label cssClass="control-label">External Promotion/Coupon Code <span class="red-star">*</span></label>
						...
						<aui:row>
							<aui:col span="12" cssClass="text-center">
								<aui:button cssClass="btn greenbtn" id="addPeriodButton"
									value="ADD PERIOD" onClick="AddAnotherPeriod()"></aui:button>
							</aui:col>
						</aui:row>
