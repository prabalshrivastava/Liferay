...
import com.sambaash.platform.srv.spshopping.service.SPTaxLocalService;
...
/**
 * Provides the base implementation for the s p tax local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.spshopping.service.impl.SPTaxLocalServiceImpl}.
 * </p>
 *
 * @author pradeep
 ...
 * @generated
 */
public abstract class SPTaxLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SPTaxLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.spshopping.service.SPTaxLocalServiceUtil} to access the s p tax local service.
	 */
	...
	@Override
	public SPTax addSPTax(SPTax spTax) throws SystemException {
		spTax.setNew(true);

		return spTaxPersistence.update(spTax);
	}
	 ...
	 */
	@Override
	public SPTax createSPTax(long spTaxId) {
		return spTaxPersistence.create(spTaxId);
	}
	...
	@Override
	public SPTax deleteSPTax(long spTaxId)
		throws PortalException, SystemException {
		return spTaxPersistence.remove(spTaxId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SPTax deleteSPTax(SPTax spTax) throws SystemException {
		return spTaxPersistence.remove(spTax);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SPTax.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return spTaxPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return spTaxPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return spTaxPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return spTaxPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public SPTax fetchSPTax(long spTaxId) throws SystemException {
		return spTaxPersistence.fetchByPrimaryKey(spTaxId);
	}
	 ...
	 */
	@Override
	public SPTax getSPTax(long spTaxId) throws PortalException, SystemException {
		return spTaxPersistence.findByPrimaryKey(spTaxId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return spTaxPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SPTax> getSPTaxs(int start, int end) throws SystemException {
		return spTaxPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSPTaxsCount() throws SystemException {
		return spTaxPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SPTax updateSPTax(SPTax spTax) throws SystemException {
		return spTaxPersistence.update(spTax);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.sambaash.platform.srv.spshopping.model.SPTax",
			spTaxLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = spTaxPersistence.getDataSource();
	...
	private SPTaxLocalServiceClpInvoker _clpInvoker = new SPTaxLocalServiceClpInvoker();
}