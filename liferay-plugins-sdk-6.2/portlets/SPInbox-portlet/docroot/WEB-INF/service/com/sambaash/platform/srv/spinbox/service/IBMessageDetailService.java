...
/**
 * Provides the remote service interface for IBMessageDetail. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author nareshchebolu
 * @see IBMessageDetailServiceUtil
...
public interface IBMessageDetailService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IBMessageDetailServiceUtil} to access the i b message detail remote service. Add custom service methods to {@link com.sambaash.platform.srv.spinbox.service.impl.IBMessageDetailServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
