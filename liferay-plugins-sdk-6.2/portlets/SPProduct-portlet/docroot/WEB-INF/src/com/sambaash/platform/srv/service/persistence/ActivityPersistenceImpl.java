...
import com.sambaash.platform.srv.NoSuchActivityException;
import com.sambaash.platform.srv.model.Activity;
import com.sambaash.platform.srv.model.impl.ActivityImpl;
import com.sambaash.platform.srv.model.impl.ActivityModelImpl;
...
public class ActivityPersistenceImpl extends BasePersistenceImpl<Activity>
	 ...
	 */
	@Override
	public Activity[] findByGroupId_PrevAndNext(long spActivityId,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchActivityException, SystemException {
		Activity activity = findByPrimaryKey(spActivityId);
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDANDMODULEID =
		new FinderPath(ActivityModelImpl.ENTITY_CACHE_ENABLED,
			...
			ActivityModelImpl.GROUPID_COLUMN_BITMASK |
			ActivityModelImpl.SPMODULEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPIDANDMODULEID = new FinderPath(ActivityModelImpl.ENTITY_CACHE_ENABLED,
			ActivityModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public List<Activity> findByGroupIdAndModuleId(long groupId, long spModuleId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<Activity> findByGroupIdAndModuleId(long groupId,
	...
	public List<Activity> findByGroupIdAndModuleId(long groupId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Activity activity : list) {
				if ((groupId != activity.getGroupId()) ||
						(spModuleId != activity.getSpModuleId())) {
					list = null;
	 ...
	 */
	@Override
	public Activity findByGroupIdAndModuleId_First(long groupId,
		long spModuleId, OrderByComparator orderByComparator)
		throws NoSuchActivityException, SystemException {
		Activity activity = fetchByGroupIdAndModuleId_First(groupId,
	 ...
	 */
	@Override
	public Activity fetchByGroupIdAndModuleId_First(long groupId,
		long spModuleId, OrderByComparator orderByComparator)
		throws SystemException {
		List<Activity> list = findByGroupIdAndModuleId(groupId, spModuleId, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public Activity findByGroupIdAndModuleId_Last(long groupId,
		long spModuleId, OrderByComparator orderByComparator)
		throws NoSuchActivityException, SystemException {
		Activity activity = fetchByGroupIdAndModuleId_Last(groupId, spModuleId,
				orderByComparator);
	 ...
	 */
	@Override
	public Activity fetchByGroupIdAndModuleId_Last(long groupId,
		long spModuleId, OrderByComparator orderByComparator)
		throws SystemException {
		...
		List<Activity> list = findByGroupIdAndModuleId(groupId, spModuleId,
	 ...
	 */
	@Override
	public Activity[] findByGroupIdAndModuleId_PrevAndNext(long spActivityId,
		...
		try {
			...
			array[0] = getByGroupIdAndModuleId_PrevAndNext(session, activity,
					groupId, spModuleId, orderByComparator, true);

			array[1] = activity;

			array[2] = getByGroupIdAndModuleId_PrevAndNext(session, activity,
	...
	protected Activity getByGroupIdAndModuleId_PrevAndNext(Session session,
		Activity activity, long groupId, long spModuleId,
	...
	public void removeByGroupIdAndModuleId(long groupId, long spModuleId)
		throws SystemException {
		for (Activity activity : findByGroupIdAndModuleId(groupId, spModuleId,
	...
	private static final String _FINDER_COLUMN_GROUPIDANDMODULEID_GROUPID_2 = "activity.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPIDANDMODULEID_SPMODULEID_2 = "activity.spModuleId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPIDANDSCHEDULEID =
		new FinderPath(ActivityModelImpl.ENTITY_CACHE_ENABLED,
			ActivityModelImpl.FINDER_CACHE_ENABLED, ActivityImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupIdAndScheduleId",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDANDSCHEDULEID =
		new FinderPath(ActivityModelImpl.ENTITY_CACHE_ENABLED,
			ActivityModelImpl.FINDER_CACHE_ENABLED, ActivityImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByGroupIdAndScheduleId",
			new String[] { Long.class.getName(), Long.class.getName() },
			ActivityModelImpl.GROUPID_COLUMN_BITMASK |
			ActivityModelImpl.SPSCHEDULEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPIDANDSCHEDULEID = new FinderPath(ActivityModelImpl.ENTITY_CACHE_ENABLED,
			ActivityModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByGroupIdAndScheduleId",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<Activity> findByGroupIdAndScheduleId(long groupId,
		long spScheduleId) throws SystemException {
		return findByGroupIdAndScheduleId(groupId, spScheduleId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<Activity> findByGroupIdAndScheduleId(long groupId,
		long spScheduleId, int start, int end) throws SystemException {
		return findByGroupIdAndScheduleId(groupId, spScheduleId, start, end,
			null);
	}
	...
	@Override
	public List<Activity> findByGroupIdAndScheduleId(long groupId,
		long spScheduleId, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDANDSCHEDULEID;
			finderArgs = new Object[] { groupId, spScheduleId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPIDANDSCHEDULEID;
			finderArgs = new Object[] {
					groupId, spScheduleId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Activity activity : list) {
				if ((groupId != activity.getGroupId()) ||
						(spScheduleId != activity.getSpScheduleId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_GROUPIDANDSCHEDULEID_GROUPID_2);

			query.append(_FINDER_COLUMN_GROUPIDANDSCHEDULEID_SPSCHEDULEID_2);
	 ...
	 */
	@Override
	public Activity findByGroupIdAndScheduleId_First(long groupId,
		long spScheduleId, OrderByComparator orderByComparator)
		throws NoSuchActivityException, SystemException {
		Activity activity = fetchByGroupIdAndScheduleId_First(groupId,
				spScheduleId, orderByComparator);
	 ...
	 */
	@Override
	public Activity fetchByGroupIdAndScheduleId_First(long groupId,
		long spScheduleId, OrderByComparator orderByComparator)
		throws SystemException {
		List<Activity> list = findByGroupIdAndScheduleId(groupId, spScheduleId,
	 ...
	 */
	@Override
	public Activity findByGroupIdAndScheduleId_Last(long groupId,
		long spScheduleId, OrderByComparator orderByComparator)
		throws NoSuchActivityException, SystemException {
		Activity activity = fetchByGroupIdAndScheduleId_Last(groupId,
				spScheduleId, orderByComparator);
	 ...
	 */
	@Override
	public Activity fetchByGroupIdAndScheduleId_Last(long groupId,
		long spScheduleId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByGroupIdAndScheduleId(groupId, spScheduleId);
	 ...
	 */
	@Override
	public Activity[] findByGroupIdAndScheduleId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupIdAndScheduleId_PrevAndNext(session, activity,
					groupId, spScheduleId, orderByComparator, true);

			array[1] = activity;

			array[2] = getByGroupIdAndScheduleId_PrevAndNext(session, activity,
					groupId, spScheduleId, orderByComparator, false);
	...
	protected Activity getByGroupIdAndScheduleId_PrevAndNext(Session session,
		Activity activity, long groupId, long spScheduleId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupIdAndScheduleId(long groupId, long spScheduleId)
		throws SystemException {
		for (Activity activity : findByGroupIdAndScheduleId(groupId,
				spScheduleId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(activity);
		}
	}
	...
	public int countByGroupIdAndScheduleId(long groupId, long spScheduleId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_GROUPIDANDSCHEDULEID;

		Object[] finderArgs = new Object[] { groupId, spScheduleId };
	...
	private static final String _FINDER_COLUMN_GROUPIDANDSCHEDULEID_GROUPID_2 = "activity.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPIDANDSCHEDULEID_SPSCHEDULEID_2 =
		"activity.spScheduleId = ?";
	 ...
	 */
	@Override
	public Activity create(long spActivityId) {
		Activity activity = new ActivityImpl();

		activity.setNew(true);
		activity.setPrimaryKey(spActivityId);
	 ...
	 */
	@Override
	public Activity remove(long spActivityId)
		throws NoSuchActivityException, SystemException {
		return remove((Serializable)spActivityId);
	}
	...
	public Activity updateImpl(
		...
		if (isNew || !ActivityModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((activityModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						activityModelImpl.getOriginalGroupId(),
						activityModelImpl.getOriginalSpModuleId()
					};
				...
				args = new Object[] {
						...
						activityModelImpl.getSpModuleId()
					};
			...
			if ((activityModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDANDSCHEDULEID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						activityModelImpl.getOriginalGroupId(),
						activityModelImpl.getOriginalSpScheduleId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_GROUPIDANDSCHEDULEID,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDANDSCHEDULEID,
					args);

				args = new Object[] {
						activityModelImpl.getGroupId(),
						activityModelImpl.getSpScheduleId()
					};
	...
	protected Activity toUnwrappedModel(Activity activity) {
		...
		activityImpl.setSpActivityId(activity.getSpActivityId());
		...
		activityImpl.setSpModuleId(activity.getSpModuleId());
		activityImpl.setSpScheduleId(activity.getSpScheduleId());
		activityImpl.setDescription(activity.getDescription());
		activityImpl.setActivityTiming(activity.getActivityTiming());
		activityImpl.setActivityPerformer(activity.getActivityPerformer());
		activityImpl.setActivityDuration(activity.getActivityDuration());
	 ...
	 */
	@Override
	public Activity findByPrimaryKey(long spActivityId)
		throws NoSuchActivityException, SystemException {
		return findByPrimaryKey((Serializable)spActivityId);
	}
	 ...
	 */
	@Override
	public Activity fetchByPrimaryKey(long spActivityId)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)spActivityId);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.sambaash.platform.srv.model.Activity")));
