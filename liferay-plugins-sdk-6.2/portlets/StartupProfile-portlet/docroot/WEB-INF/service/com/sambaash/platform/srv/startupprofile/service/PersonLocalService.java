...
public interface PersonLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PersonLocalServiceUtil} to access the person local service. Add custom service methods to {@link com.sambaash.platform.srv.startupprofile.service.impl.PersonLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public com.sambaash.platform.srv.startupprofile.model.Person addPerson(
	...
	*/
	public com.sambaash.platform.srv.startupprofile.model.Person createPerson(
		long personId);
	...
	*/
	...
	public com.sambaash.platform.srv.startupprofile.model.Person deletePerson(
		long personId)
	...
	*/
	...
	public com.sambaash.platform.srv.startupprofile.model.Person fetchPerson(
		long personId)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.sambaash.platform.srv.startupprofile.model.Person fetchPersonByUuidAndCompanyId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.sambaash.platform.srv.startupprofile.model.Person fetchPersonByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.sambaash.platform.srv.startupprofile.model.Person getPerson(
		long personId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.sambaash.platform.srv.startupprofile.model.Person getPersonByUuidAndCompanyId(
		java.lang.String uuid, long companyId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.sambaash.platform.srv.startupprofile.model.Person getPersonByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.sambaash.platform.srv.startupprofile.model.Person> getPersons(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public com.sambaash.platform.srv.startupprofile.model.Person updatePerson(
		com.sambaash.platform.srv.startupprofile.model.Person person)
		throws com.liferay.portal.kernel.exception.SystemException;
