 ...
 * @generated
 */
public abstract class SPLikesActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPLikesActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPLikesLocalServiceUtil.getService());
		setClass(SPLikes.class);

		setClassLoader(com.sambaash.platform.srv.spservices.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spLikesId");
	}
}