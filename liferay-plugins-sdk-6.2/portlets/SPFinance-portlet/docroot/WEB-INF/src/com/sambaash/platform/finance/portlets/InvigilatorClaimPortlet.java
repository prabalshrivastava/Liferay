 ...
 */
public class InvigilatorClaimPortlet extends MVCPortlet {
	 ...
	 */
	private Log log = LogFactoryUtil.getLog(InvigilatorClaimPortlet.class.getName());
	...
	public void savePreferences(ActionRequest actionRequest, ActionResponse actionResponse) {
		...
		String notificationDetailUrl = ParamUtil.getString(actionRequest, FinanceConstants.PREF_SUBMIT_CLAIM_DETAIL_URL, "");
		String disclaimerHyperLink = ParamUtil.getString(actionRequest, FinanceConstants.PREF_DISCLAIMER_HYPERLINK, "");
		try {
			...
			preferences.setValue(FinanceConstants.PREF_SUBMIT_CLAIM_DETAIL_URL, notificationDetailUrl);
			preferences.setValue(FinanceConstants.PREF_DISCLAIMER_HYPERLINK, disclaimerHyperLink);
			preferences.store();
