package com.sambaash.platform.invigilatormanagement.notifyappointment;
...
import com.sambaash.platform.invigilatormanagement.action.ajax.SendNotificationActionHandler;
import com.sambaash.platform.invigilatormanagement.action.ajax.SendRequestActionHandler;
import com.sambaash.platform.invigilatormanagement.action.ajax.UniqueListActionHandler;

/**
 * Portlet implementation class InvigilatorApplicationPortlet
 */
public class NotifyAppointment extends MVCPortlet {
	...
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("uniquedata", UniqueListActionHandler.class);
		...
		// getElasticSearchListing1
	}
	/**
	 * This is an object of Log class
	 */
	private Log log = LogFactoryUtil.getLog(NotifyAppointment.class.getName());
	...
	public void savePreferences(ActionRequest actionRequest, ActionResponse actionResponse) {
		...
		String manageAppointmentUrlPref = ParamUtil.getString(actionRequest, "manageAppointmentUrlPref", "");
		String manageAppointmentAdminUrlPref = ParamUtil.getString(actionRequest, "manageAppointmentAdminUrlPref", "");
		try {
			...
			preferences.setValue("manageAppointmentUrlPref", manageAppointmentUrlPref);
			preferences.setValue("manageAppointmentAdminUrlPref", manageAppointmentAdminUrlPref);
			preferences.store();
