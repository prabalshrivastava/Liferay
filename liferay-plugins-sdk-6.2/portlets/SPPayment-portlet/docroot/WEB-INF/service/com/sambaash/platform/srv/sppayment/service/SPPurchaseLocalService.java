...
/**
 * Provides the local service interface for SPPurchase. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pradeep
 * @see SPPurchaseLocalServiceUtil
...
public interface SPPurchaseLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPPurchaseLocalServiceUtil} to access the s p purchase local service. Add custom service methods to {@link com.sambaash.platform.srv.sppayment.service.impl.SPPurchaseLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
