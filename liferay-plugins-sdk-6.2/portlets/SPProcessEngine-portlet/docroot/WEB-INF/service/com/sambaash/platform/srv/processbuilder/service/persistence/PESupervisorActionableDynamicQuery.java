 ...
 * @generated
 */
public abstract class PESupervisorActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PESupervisorActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PESupervisorLocalServiceUtil.getService());
		setClass(PESupervisor.class);

		setClassLoader(com.sambaash.platform.srv.processbuilder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPESupervisorId");
	}
}