...
/**
 * Provides the local service interface for Certificate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see CertificateLocalServiceUtil
...
public interface CertificateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CertificateLocalServiceUtil} to access the certificate local service. Add custom service methods to {@link com.sambaash.platform.srv.service.impl.CertificateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
