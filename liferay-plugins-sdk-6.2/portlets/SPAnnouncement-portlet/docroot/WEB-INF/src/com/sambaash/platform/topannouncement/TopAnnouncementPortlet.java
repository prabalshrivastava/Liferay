package com.sambaash.platform.topannouncement;
 ...
 */
public class TopAnnouncementPortlet extends MVCPortlet {
 

	private static final Log log = LogFactoryUtil.getLog(TopAnnouncementPortlet.class);
