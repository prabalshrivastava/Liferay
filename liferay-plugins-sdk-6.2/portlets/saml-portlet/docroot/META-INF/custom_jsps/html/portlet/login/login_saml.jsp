...
<%@ page import="com.liferay.saml.service.SamlConfigLocalServiceUtil" %>

<%
	boolean samlEnabled = false;
	try {
		samlEnabled = SamlConfigLocalServiceUtil.isEnabled(company.getCompanyId(), themeDisplay.getScopeGroupId());
	} catch (Exception e) {}
%>
<c:choose>
