...
/**
 * Provides the local service utility for MembershipSubscription. This utility wraps
 * {@link com.sambaash.platform.srv.spservices.service.impl.MembershipSubscriptionLocalServiceImpl} and is the
 ...
 * @see com.sambaash.platform.srv.spservices.service.impl.MembershipSubscriptionLocalServiceImpl
 * @generated
 */
public class MembershipSubscriptionLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.sambaash.platform.srv.spservices.service.impl.MembershipSubscriptionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.sambaash.platform.srv.spservices.model.MembershipSubscription addMembershipSubscription(
		com.sambaash.platform.srv.spservices.model.MembershipSubscription membershipSubscription)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addMembershipSubscription(membershipSubscription);
	}
	...
	*/
	public static com.sambaash.platform.srv.spservices.model.MembershipSubscription createMembershipSubscription(
		long msId) {
		return getService().createMembershipSubscription(msId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spservices.model.MembershipSubscription deleteMembershipSubscription(
		long msId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteMembershipSubscription(msId);
	}
	...
	*/
	public static com.sambaash.platform.srv.spservices.model.MembershipSubscription deleteMembershipSubscription(
		com.sambaash.platform.srv.spservices.model.MembershipSubscription membershipSubscription)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteMembershipSubscription(membershipSubscription);
	}
	...
	*/
	...
	public static com.sambaash.platform.srv.spservices.model.MembershipSubscription fetchMembershipSubscription(
		long msId) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchMembershipSubscription(msId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spservices.model.MembershipSubscription getMembershipSubscription(
		long msId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getMembershipSubscription(msId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.spservices.model.MembershipSubscription> getMembershipSubscriptions(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getMembershipSubscriptions(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getMembershipSubscriptionsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getMembershipSubscriptionsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.spservices.model.MembershipSubscription updateMembershipSubscription(
		com.sambaash.platform.srv.spservices.model.MembershipSubscription membershipSubscription)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateMembershipSubscription(membershipSubscription);
	}
	...
	*/
	...
	public static java.util.List<com.sambaash.platform.srv.spservices.model.MembershipSubscription> findByMembershipSubscriptionName(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByMembershipSubscriptionName(name);
	}

	public static java.util.List<com.sambaash.platform.srv.spservices.model.MembershipSubscription> findByMembershipSubscriptionName(
		java.lang.String name, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByMembershipSubscriptionName(name, start, end);
	}
	...
	public static java.util.List<com.sambaash.platform.srv.spservices.model.MembershipSubscription> findByMembershipSubscriptionGroupId(
		long groupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByMembershipSubscriptionGroupId(groupId);
	}
	...
	public static java.util.List<com.sambaash.platform.srv.spservices.model.MembershipSubscription> findByMembershipSubscriptionUserId(
		...
		return getService().findByMembershipSubscriptionUserId(userId);
	}
	...
	public static java.util.List<com.sambaash.platform.srv.spservices.model.MembershipSubscription> findByMembershipSubscriptionMpId_1(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByMembershipSubscriptionMpId_1(mpId_1);
	}
	...
	public static java.util.List<com.sambaash.platform.srv.spservices.model.MembershipSubscription> findByMembershipSubscriptionSessionId(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByMembershipSubscriptionSessionId(userName);
	}
	...
	public static MembershipSubscriptionLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					MembershipSubscriptionLocalService.class.getName());

			if (invokableLocalService instanceof MembershipSubscriptionLocalService) {
				_service = (MembershipSubscriptionLocalService)invokableLocalService;
			}
			else {
				_service = new MembershipSubscriptionLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(MembershipSubscriptionLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(MembershipSubscriptionLocalService service) {
	}

	private static MembershipSubscriptionLocalService _service;
}