			...
			<div class="mobile_header_cta">
					...
					<div class="companyLogo2">
						<a href="http://www.unilever.com" target="_blank">
							<img src="${themeDisplay.getPathThemeImages()}/header-footer/bhp_wht_logo.svg" class="ul_white" width="35" height="40"  alt="Logo"/>
							<img src="${themeDisplay.getPathThemeImages()}/header-footer/bhp_wht_logo.svg" class="ul_gray" width="35" height="40"  alt="Logo"/>
						</a>
					</div>   
    			</div>
		</div>
