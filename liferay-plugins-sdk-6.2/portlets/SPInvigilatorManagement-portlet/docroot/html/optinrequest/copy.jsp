...
function validateFormIOForm(thisInstance){
	...
	if(formdata.OptInWithEffectFrom == ""){
		thisInstance.form.setAlert("","Please Fill up Opt In With Effect From");
	}
	else{
		var optInWithEffectFrom = formdata.OptInWithEffectFrom;
	 	var data1 = {"limit":4,"modelName":modelName,"page":0,"formType":modelName};
	 	data1.conditions = ["contentJson.OptInWithEffectFrom="+optInWithEffectFrom];
	 	data1.sortBy = "contentJson.OptInWithEffectFrom";
...
function afterFormDataLoadedFormIOForm(thisInstance){
	...
	thisInstance.components.TaxCode.setValue("Copy-of-"+ thisInstance.components.TaxCode.value);
}
</script>
<% } %>