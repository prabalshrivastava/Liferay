...
/**
 * Provides the local service interface for SPFeedback. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see SPFeedbackLocalServiceUtil
...
public interface SPFeedbackLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPFeedbackLocalServiceUtil} to access the s p feedback local service. Add custom service methods to {@link com.sambaash.platform.srv.feedback.service.impl.SPFeedbackLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
