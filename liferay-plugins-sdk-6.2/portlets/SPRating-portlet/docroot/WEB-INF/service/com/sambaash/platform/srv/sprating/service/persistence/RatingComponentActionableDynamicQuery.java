 ...
 * @generated
 */
public abstract class RatingComponentActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RatingComponentActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RatingComponentLocalServiceUtil.getService());
		setClass(RatingComponent.class);

		setClassLoader(com.sambaash.platform.srv.sprating.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spRatingComponentId");
	}
}