...
/**
 * Provides the local service interface for VideoFileEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see VideoFileEntryLocalServiceUtil
...
public interface VideoFileEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VideoFileEntryLocalServiceUtil} to access the video file entry local service. Add custom service methods to {@link com.sambaash.platform.srv.video.service.impl.VideoFileEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
