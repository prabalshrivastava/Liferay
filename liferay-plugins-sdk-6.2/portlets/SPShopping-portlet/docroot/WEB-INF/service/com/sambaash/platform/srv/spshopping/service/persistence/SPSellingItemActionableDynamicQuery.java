 ...
 * @generated
 */
public abstract class SPSellingItemActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPSellingItemActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPSellingItemLocalServiceUtil.getService());
		setClass(SPSellingItem.class);

		setClassLoader(com.sambaash.platform.srv.spshopping.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spSellingItemId");
	}
}