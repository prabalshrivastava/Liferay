 ...
 * @generated
 */
public abstract class ExamBodyUserActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ExamBodyUserActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ExamBodyUserLocalServiceUtil.getService());
		setClass(ExamBodyUser.class);

		setClassLoader(com.sambaash.platform.srv.spsocialprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("examBodyUserId");
	}
}