...
package com.sambaash.platform.srv.rsvp.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			RsvpLocalServiceUtil.clearService();

			RsvpCoParticipantDetailLocalServiceUtil.clearService();

			RsvpDetailLocalServiceUtil.clearService();

			RsvpDiscountLocalServiceUtil.clearService();

			RsvpPaymentLocalServiceUtil.clearService();

			RsvpPromoCodeLocalServiceUtil.clearService();

			RsvpTicketLocalServiceUtil.clearService();
		}
	}
}