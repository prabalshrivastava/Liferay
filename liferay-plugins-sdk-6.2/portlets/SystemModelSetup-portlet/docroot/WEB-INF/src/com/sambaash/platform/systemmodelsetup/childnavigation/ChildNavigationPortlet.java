package com.sambaash.platform.systemmodelsetup.childnavigation;
...
import com.sambaash.platform.systemmodelsetup.action.ajax.FetchChildLayoutsActionHandler;
import com.sambaash.platform.systemmodelsetup.action.ajax.FetchFormFieldsActionHandler;
import com.sambaash.platform.systemmodelsetup.action.ajax.FileDownloadActionHandler;
...
/**
 * Portlet implementation class ChildNavigationPortlet
 */
public class ChildNavigationPortlet extends MVCPortlet {
	...
	static {
		...
		SERVE_RESOURCE_MANAGER.registerResourceActionHandler("fetchChildLayouts",FetchChildLayoutsActionHandler.class);
	}
	/**
	 * This is an object of Log class
	 */
	private Log log = LogFactoryUtil.getLog(ChildNavigationPortlet.class.getName());
