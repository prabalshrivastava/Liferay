 ...
 * @generated
 */
public abstract class RelationshipActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RelationshipActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RelationshipLocalServiceUtil.getService());
		setClass(Relationship.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("relationshipId");
	}
}