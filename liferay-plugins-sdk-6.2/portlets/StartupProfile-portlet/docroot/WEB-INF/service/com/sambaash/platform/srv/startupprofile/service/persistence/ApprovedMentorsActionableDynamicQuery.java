 ...
 * @generated
 */
public abstract class ApprovedMentorsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ApprovedMentorsActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ApprovedMentorsLocalServiceUtil.getService());
		setClass(ApprovedMentors.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("mentorId");
	}
}