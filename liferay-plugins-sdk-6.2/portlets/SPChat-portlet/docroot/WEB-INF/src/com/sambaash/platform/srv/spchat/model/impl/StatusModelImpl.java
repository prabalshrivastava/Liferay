...
import com.sambaash.platform.srv.spchat.model.StatusModel;
...
/**
 * The base model implementation for the Status service. Represents a row in the &quot;SPChatStatus&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.sambaash.platform.srv.spchat.model.StatusModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link StatusImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see StatusImpl
 * @see com.sambaash.platform.srv.spchat.model.Status
 * @see com.sambaash.platform.srv.spchat.model.StatusModel
 * @generated
 */
public class StatusModelImpl extends BaseModelImpl<Status>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a status model instance should use the {@link com.sambaash.platform.srv.spchat.model.Status} interface instead.
	 */
	public static final String TABLE_NAME = "SPChatStatus";
	...
	public static final String TABLE_SQL_CREATE = "create table SPChatStatus (statusId BIGINT(20) not null primary key,userId BIGINT(20),modifiedDate BIGINT(20),online_ BOOLEAN,awake BOOLEAN,activePanelIds VARCHAR(75) null,message VARCHAR(75) null,playSound BOOLEAN)";
	public static final String TABLE_SQL_DROP = "drop table SPChatStatus";
	public static final String ORDER_BY_JPQL = " ORDER BY status.statusId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY SPChatStatus.statusId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.sambaash.platform.srv.spchat.model.Status"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.sambaash.platform.srv.spchat.model.Status"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.sambaash.platform.srv.spchat.model.Status"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.sambaash.platform.srv.spchat.model.Status"));
