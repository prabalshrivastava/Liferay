...
/**
 * Provides the local service interface for SPComponentTemplate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author WattabyteIT
 * @see SPComponentTemplateLocalServiceUtil
...
public interface SPComponentTemplateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPComponentTemplateLocalServiceUtil} to access the s p component template local service. Add custom service methods to {@link com.sambaash.platform.srv.template.service.impl.SPComponentTemplateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
