...
public class CreateAccountAction extends PortletAction {
	...
	protected void addUser(
		...
		_log.info("Liferay Create Account Action");
		...
		try {
			...
			serviceContext.setAttribute("subProductId", subProductId);
			serviceContext.setAttribute("userType", "General User");

			_log.error(String.format("subProductId %s, userType %s, emailAddress %s, URLCurrent %s", subProductId,
					"General User", themeDisplay.getURLCurrent(), emailAddress));
	...
	private static Log _log = LogFactoryUtil.getLog(com.liferay.portlet.login.action.CreateAccountAction.class);
