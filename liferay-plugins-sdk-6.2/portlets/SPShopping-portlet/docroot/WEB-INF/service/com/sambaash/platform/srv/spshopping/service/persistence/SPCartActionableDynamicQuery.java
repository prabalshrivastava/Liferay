 ...
 * @generated
 */
public abstract class SPCartActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPCartActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPCartLocalServiceUtil.getService());
		setClass(SPCart.class);

		setClassLoader(com.sambaash.platform.srv.spshopping.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spCartId");
	}
}