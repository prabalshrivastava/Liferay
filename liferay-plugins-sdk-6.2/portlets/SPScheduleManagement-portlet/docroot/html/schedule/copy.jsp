					...
					<aui:row>
						<aui:col span="12">
								...
								<aui:col span="6" cssClass="formio-component-textfield ">
									<div class="form-group has-error">
										...
										<aui:input type="text" name="" id="scheduleCode"
											...
											<div class="formio-errors invalid-feedback hide" ><p class="help-block">Schedule Code is required</p>
											</div>	
									</div>
								</aui:col>
							</aui:row>
									...
									<aui:col span="6">
										<div class="form-group has-error">
											...
											<aui:input type="text" name="" cssClass="form-control"
												id="startDate" placeholder="dd/mm/yyyy" autocomplete="off"/>
							...
							<aui:row id="briefing_reporting">
								...
								<aui:col span="6" cssClass="choices formio-choices">
									<div class="form-group">
										<label class="control-label">Reporting: Mins before
									...
									<form class="formContainer" action="">
										...
										<aui:row>
											<aui:col span="12" cssClass="userAction">
												...
												<button
													class="btn cancel btn-primary popup-cancel pull-right">Go
													Back</button>
											</aui:col>
										</aui:row>
														...
														<div class="form-check formio-component-datetime radio">
															...
															<div class="form-group">
																<input type="text" name="" class="form-control"
																	id="<portlet:namespace/>endOn" placeholder="dd/mm/yyyy" />
																<span class="input-group-addon" style="cursor: pointer"><i
																	class="glyphicon glyphicon-calendar"></i></span>
															</div>
														</div>
							...
							<aui:row cssClass="posRelative">
								<aui:col span="12" cssClass="text-center">
									<button type="button"
										...
										<span>+</span>ADD ANOTHER SUB SCHEDULE</span>
									</button>
							...
							<div class="row userAction">
								<div class="col-sm-12 text-center">
										...
										<button type="button" id="save" class="btn btn-primary"
											onclick="validateFields(this)" name = "update">Publish</button>
