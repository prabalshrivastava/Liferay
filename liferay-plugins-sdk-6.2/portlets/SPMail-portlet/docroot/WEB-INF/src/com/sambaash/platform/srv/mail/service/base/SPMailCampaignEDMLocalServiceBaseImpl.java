...
import com.sambaash.platform.srv.mail.service.SPMailCampaignEDMLocalService;
...
/**
 * Provides the base implementation for the s p mail campaign e d m local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.mail.service.impl.SPMailCampaignEDMLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SPMailCampaignEDMLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SPMailCampaignEDMLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.mail.service.SPMailCampaignEDMLocalServiceUtil} to access the s p mail campaign e d m local service.
	 */
	...
	@Override
	public SPMailCampaignEDM addSPMailCampaignEDM(
		SPMailCampaignEDM spMailCampaignEDM) throws SystemException {
		spMailCampaignEDM.setNew(true);

		return spMailCampaignEDMPersistence.update(spMailCampaignEDM);
	}
	 ...
	 */
	@Override
	public SPMailCampaignEDM createSPMailCampaignEDM(long spMailCampaignEDMId) {
		return spMailCampaignEDMPersistence.create(spMailCampaignEDMId);
	}
	...
	@Override
	public SPMailCampaignEDM deleteSPMailCampaignEDM(long spMailCampaignEDMId)
		throws PortalException, SystemException {
		return spMailCampaignEDMPersistence.remove(spMailCampaignEDMId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SPMailCampaignEDM deleteSPMailCampaignEDM(
		SPMailCampaignEDM spMailCampaignEDM) throws SystemException {
		return spMailCampaignEDMPersistence.remove(spMailCampaignEDM);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SPMailCampaignEDM.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return spMailCampaignEDMPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return spMailCampaignEDMPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SPMailCampaignEDM fetchSPMailCampaignEDM(long spMailCampaignEDMId)
		throws SystemException {
		return spMailCampaignEDMPersistence.fetchByPrimaryKey(spMailCampaignEDMId);
	}
	 ...
	 */
	@Override
	public SPMailCampaignEDM getSPMailCampaignEDM(long spMailCampaignEDMId)
		throws PortalException, SystemException {
		return spMailCampaignEDMPersistence.findByPrimaryKey(spMailCampaignEDMId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return spMailCampaignEDMPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SPMailCampaignEDM> getSPMailCampaignEDMs(int start, int end)
		throws SystemException {
		return spMailCampaignEDMPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSPMailCampaignEDMsCount() throws SystemException {
		return spMailCampaignEDMPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SPMailCampaignEDM updateSPMailCampaignEDM(
		SPMailCampaignEDM spMailCampaignEDM) throws SystemException {
		return spMailCampaignEDMPersistence.update(spMailCampaignEDM);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.sambaash.platform.srv.mail.model.SPMailCampaignEDM",
			spMailCampaignEDMLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = spMailCampaignEDMPersistence.getDataSource();
	...
	private SPMailCampaignEDMLocalServiceClpInvoker _clpInvoker = new SPMailCampaignEDMLocalServiceClpInvoker();
}