...
/**
 * Provides the local service interface for SPSearchFilter. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author harini
 * @see SPSearchFilterLocalServiceUtil
...
public interface SPSearchFilterLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPSearchFilterLocalServiceUtil} to access the s p search filter local service. Add custom service methods to {@link com.sambaash.platform.srv.filter.service.impl.SPSearchFilterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
