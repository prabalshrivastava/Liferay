...
/**
 * Provides the local service interface for SPMailSubscriberUserAgent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see SPMailSubscriberUserAgentLocalServiceUtil
...
public interface SPMailSubscriberUserAgentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPMailSubscriberUserAgentLocalServiceUtil} to access the s p mail subscriber user agent local service. Add custom service methods to {@link com.sambaash.platform.srv.mail.service.impl.SPMailSubscriberUserAgentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
