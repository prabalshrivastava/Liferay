...
var FeeDetails = function(config){
	var A;
	var instance;
	this.init = function(config){
	   ...
	   this.editFeeDetails = config.editFeeDetails;
	...
	this.addInstmntRows = function(defaultInstmntRowsData){
		...
		for(var i = 0; i < count ; i++){
			...
			if (!instance.editFeeDetails && (!defaultInstmntRowsData || defaultInstmntRowsData.length <= 0)){
				newRow.one("#"+triggerId).set("value", instance.getCurrentDate());
			}
