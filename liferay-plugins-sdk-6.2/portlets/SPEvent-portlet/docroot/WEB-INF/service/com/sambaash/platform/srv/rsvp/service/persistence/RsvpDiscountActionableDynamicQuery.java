 ...
 * @generated
 */
public abstract class RsvpDiscountActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RsvpDiscountActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RsvpDiscountLocalServiceUtil.getService());
		setClass(RsvpDiscount.class);

		setClassLoader(com.sambaash.platform.srv.rsvp.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("rsvpDiscountId");
	}
}