...
/**
 * The persistence utility for the s p mail campaign e d m service. This utility wraps {@link SPMailCampaignEDMPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class SPMailCampaignEDMUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(SPMailCampaignEDM spMailCampaignEDM) {
		getPersistence().clearCache(spMailCampaignEDM);
	}
	 ...
	 */
	public static List<SPMailCampaignEDM> findWithDynamicQuery(
	 ...
	 */
	public static SPMailCampaignEDM update(SPMailCampaignEDM spMailCampaignEDM)
		throws SystemException {
		return getPersistence().update(spMailCampaignEDM);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static SPMailCampaignEDM update(
		SPMailCampaignEDM spMailCampaignEDM, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(spMailCampaignEDM, serviceContext);
	}
	...
	*/
	public static java.util.List<com.sambaash.platform.srv.mail.model.SPMailCampaignEDM> findByCampaignId(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM findByCampaignId_First(
		long spMailCampaignId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM fetchByCampaignId_First(
		long spMailCampaignId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM findByCampaignId_Last(
		long spMailCampaignId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.mail.NoSuchCampaignEDMException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM fetchByCampaignId_Last(
		long spMailCampaignId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM[] findByCampaignId_PrevAndNext(
		long spMailCampaignEDMId, long spMailCampaignId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.mail.NoSuchCampaignEDMException {
		return getPersistence()
				   .findByCampaignId_PrevAndNext(spMailCampaignEDMId,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM findByCampaignIdMailType(
		long spMailCampaignId, int seqNo)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.mail.NoSuchCampaignEDMException {
		return getPersistence().findByCampaignIdMailType(spMailCampaignId, seqNo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM fetchByCampaignIdMailType(
		long spMailCampaignId, int seqNo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .fetchByCampaignIdMailType(spMailCampaignId, seqNo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM removeByCampaignIdMailType(
		long spMailCampaignId, int seqNo)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.mail.NoSuchCampaignEDMException {
		return getPersistence()
				   .removeByCampaignIdMailType(spMailCampaignId, seqNo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int countByCampaignIdMailType(long spMailCampaignId, int seqNo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .countByCampaignIdMailType(spMailCampaignId, seqNo);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(spMailCampaignEDM);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(spMailCampaignEDMs);
	}
	...
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM create(
		long spMailCampaignEDMId) {
		return getPersistence().create(spMailCampaignEDMId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM remove(
		long spMailCampaignEDMId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.mail.NoSuchCampaignEDMException {
		return getPersistence().remove(spMailCampaignEDMId);
	}

	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM updateImpl(
		com.sambaash.platform.srv.mail.model.SPMailCampaignEDM spMailCampaignEDM)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(spMailCampaignEDM);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM findByPrimaryKey(
		long spMailCampaignEDMId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.mail.NoSuchCampaignEDMException {
		return getPersistence().findByPrimaryKey(spMailCampaignEDMId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.mail.model.SPMailCampaignEDM fetchByPrimaryKey(
		long spMailCampaignEDMId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(spMailCampaignEDMId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.mail.model.SPMailCampaignEDM> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static SPMailCampaignEDMPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SPMailCampaignEDMPersistence)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.mail.service.ClpSerializer.getServletContextName(),
					SPMailCampaignEDMPersistence.class.getName());

			ReferenceRegistry.registerReference(SPMailCampaignEDMUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(SPMailCampaignEDMPersistence persistence) {
	}

	private static SPMailCampaignEDMPersistence _persistence;
}