	...
	protected static String replaceTokens(
		...
		return StringUtil.replace(
			...
			new String[] {
				...
				"[$PORTLET_NAME$]", "[$TO_ADDRESS$]", "[$TO_NAME$]","[$LOGO_URL$]","[$BG_COLOR$]","[$COPY_RIGHT$]"
			},
			new String[] {
				...
				GetterUtil.getString(attributes.get("logo")),
				GetterUtil.getString(attributes.get("headerBkgColor")),
				GetterUtil.getString(attributes.get("copyright"))
			});
	}
