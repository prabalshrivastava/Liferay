...
package com.sambaash.platform.srv.spchallenge.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SPChallengeLocalServiceUtil.clearService();

			SPChallengeApplicantLocalServiceUtil.clearService();
		}
	}
}