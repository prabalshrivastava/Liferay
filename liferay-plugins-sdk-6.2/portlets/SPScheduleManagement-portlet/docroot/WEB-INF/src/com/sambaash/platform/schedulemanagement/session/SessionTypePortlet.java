package com.sambaash.platform.schedulemanagement.session;
...
/**
 * Portlet implementation class SessionType
 */
public class SessionTypePortlet extends MVCPortlet {
	 ...
	 */
	private Log _log = LogFactoryUtil.getLog(SessionTypePortlet.class.getName());
