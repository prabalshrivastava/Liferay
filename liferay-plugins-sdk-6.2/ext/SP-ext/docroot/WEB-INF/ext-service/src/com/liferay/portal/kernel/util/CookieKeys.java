...
public class CookieKeys {
	...
	public static void addCookie(
		...
		if (_log.isDebugEnabled()) {
			_log.debug("Derive cookie secure or not - request.isSecure() : " + request.isSecure());
		}
	...
	public static void addCookie(HttpServletRequest request, HttpServletResponse response, Cookie cookie,
			boolean secure) {
		addCookie(request, response, cookie, true, true);
	}
	...
	public static void addCookie(
			...
			if (_log.isDebugEnabled()) {
				_log.debug("Is cookie secure : " + secure);
			}
	...
	public static String getCookie(
		...
		if(name.equalsIgnoreCase(COOKIE_SUPPORT)){
			return "true";
		}
