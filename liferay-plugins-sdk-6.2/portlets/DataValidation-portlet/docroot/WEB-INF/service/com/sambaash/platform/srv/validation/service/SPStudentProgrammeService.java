...
/**
 * Provides the remote service interface for SPStudentProgramme. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author gauravvijayvergia
 * @see SPStudentProgrammeServiceUtil
...
public interface SPStudentProgrammeService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPStudentProgrammeServiceUtil} to access the s p student programme remote service. Add custom service methods to {@link com.sambaash.platform.srv.validation.service.impl.SPStudentProgrammeServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
