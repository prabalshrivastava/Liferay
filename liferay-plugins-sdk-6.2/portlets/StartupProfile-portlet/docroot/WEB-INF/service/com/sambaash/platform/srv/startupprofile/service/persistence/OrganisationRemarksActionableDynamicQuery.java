 ...
 * @generated
 */
public abstract class OrganisationRemarksActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OrganisationRemarksActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(OrganisationRemarksLocalServiceUtil.getService());
		setClass(OrganisationRemarks.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("remarksId");
	}
}