...
/**
 * Provides the local service interface for RsvpDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see RsvpDetailLocalServiceUtil
...
public interface RsvpDetailLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RsvpDetailLocalServiceUtil} to access the rsvp detail local service. Add custom service methods to {@link com.sambaash.platform.srv.rsvp.service.impl.RsvpDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
