...
<%
	...
	String listingHeaderName = renderRequest.getPreferences().getValue("listHeaderPref","");
	String submitClaimDetailUrl = renderRequest.getPreferences().getValue("submitClaimDetailUrlPref","");
	String disclaimerHyperLink = renderRequest.getPreferences().getValue("disclaimerHyperLinkUrlPref","");	
%>
...
<aui:row cssClass="ps-pref-container" style="margin:10px auto; max-width:640px">
	<aui:col span="12">
		<aui:form name="editPreferences" action="<%=savePreferencesActionURL%>">	
			<aui:input name="listHeaderPref" label="Listing Header Name" value='<%=listingHeaderName%>'></aui:input>		
			...
			<aui:input name="submitClaimDetailUrlPref" label="Submitted Claim Detail URL" value='<%=submitClaimDetailUrl%>'></aui:input>
			<aui:input name="disclaimerHyperLinkUrlPref" label="Disclaimer Hyper Link" value='<%=disclaimerHyperLink%>'></aui:input>
			<aui:button-row>
