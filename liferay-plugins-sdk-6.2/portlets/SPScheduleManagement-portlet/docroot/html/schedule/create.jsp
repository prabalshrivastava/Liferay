...
<style>
.aui .datepicker-popover.popover {
	position: fixed !important;
    top: 250px !important;
}
.aui .timepicker-popover.popover{
	position:fixed;
	top: 300px !important;	
						...
						<aui:col span="12">
							...
							<aui:row>
								...
								<aui:col span="6" cssClass="form-group formio-component-datetime">
									...
									<aui:col span="6">
										<div class="form-group has-error">
											<label class="control-label dnone">To Date <span class="star">*</span></label>
	                  ...
	                  <!-- pop up success -->
								...
								<div id="sucess-popup" hidden="true" class="modalpopupBox">
									<div id="sucess-popup-box" class="modalpopupContent">
										<form class="formContainer">
											<aui:row>
												<aui:col span="12">
													<h3 id="success-msg">Schedule Created Sucessfully!</h3>
												</aui:col>
							...
							<div class="col-sm-12">
								<div class="col-sm-12 text-center" >
									<button type="button" class="btn btn-default" id="saveDraft" onClick="saveDraftFields();">Save Draft</button>
									<!-- <button type="button" class="btn btn-primary" onClick="validateFields()" id="save" style="display: none">Publish</button> -->
									<button type="button" class="btn btn-primary" id="save" onClick="validateFields(this);">Publish</button>
									<button type="button"  onclick="resetForm(this);"  class="btn btn-default">CLEAR</button>
...
var sheduleBase=document.getElementById('sheduleContainer');
var scheduleCategory = document.getElementById(namespace+"scheduleCategory");
var subjectProgramme = document.getElementById(namespace+"subjectProgramme");
...
AUI().use('event-base', function (A) {
	A.on('domready', function () {
	 	loadDefaultData();
		//setInterval(function(){ checkForm(); }, 1000);
