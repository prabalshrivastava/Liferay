 ...
 * @generated
 */
public abstract class PEProcessStatusTypeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PEProcessStatusTypeActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(PEProcessStatusTypeLocalServiceUtil.getService());
		setClass(PEProcessStatusType.class);

		setClassLoader(com.sambaash.platform.srv.processbuilder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPEProcessStatusTypeId");
	}
}