...
import com.sambaash.platform.srv.spmicroservice.service.SPMicroserviceLocalService;

import javax.sql.DataSource;

/**
 * Provides the base implementation for the s p microservice local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.spmicroservice.service.impl.SPMicroserviceLocalServiceImpl}.
 * </p>
 *
 * @author glenn
 ...
 * @generated
 */
public abstract class SPMicroserviceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SPMicroserviceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.spmicroservice.service.SPMicroserviceLocalServiceUtil} to access the s p microservice local service.
	 */
	...
	private SPMicroserviceLocalServiceClpInvoker _clpInvoker = new SPMicroserviceLocalServiceClpInvoker();
}