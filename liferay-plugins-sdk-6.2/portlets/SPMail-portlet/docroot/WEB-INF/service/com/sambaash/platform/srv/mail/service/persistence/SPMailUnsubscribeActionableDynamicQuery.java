 ...
 * @generated
 */
public abstract class SPMailUnsubscribeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPMailUnsubscribeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPMailUnsubscribeLocalServiceUtil.getService());
		setClass(SPMailUnsubscribe.class);

		setClassLoader(com.sambaash.platform.srv.mail.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spMailUnsubscribeId");
	}
}