 ...
 * @generated
 */
public abstract class SocialProfileLikeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SocialProfileLikeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SocialProfileLikeLocalServiceUtil.getService());
		setClass(SocialProfileLike.class);

		setClassLoader(com.sambaash.platform.srv.spsocialprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("socialProfileLikeId");
	}
}