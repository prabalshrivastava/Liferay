...
<script>
var config = {
		createPage: "/html/optoutrequest/create.jsp",
	    editPage: "/html/optoutrequest/edit.jsp",
	    detailPage: "/html/optoutrequest/view.jsp",
	    copyPage: "/html/optoutrequest/copy.jsp"
	};
