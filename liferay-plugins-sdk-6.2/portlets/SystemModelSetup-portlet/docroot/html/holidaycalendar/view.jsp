...
taglib
	uri="http://liferay.com/tld/theme" prefix="liferay-theme"%><%@ExamBody
taglib
...
<portlet:renderURL var="holidayCalendarListing">
	<portlet:param name="jspPage" value="/html/holidaycalendar/list.jsp" />
</portlet:renderURL>
							...
							<div class="row">
								<div class="col col-sm-4">
									...
									<div class="form-group formio-component-textfield">
										<input type="text" name="year" id="inp_year"
		...
		<div id="modalBox" class="modalpopupBox" hidden="true">
			<div id="modalContent" class="modalpopupContent">
				<form class="formContainer ">
						...
						<aui:col span="12">
							...
							<div class="form-group formio-component-textfield">
								<input type="text" name="date" autocomplete="off"
									class="form-conrol" id="inp_date" /><i class="dateIcon"></i> <input
						...
						<aui:col span="12">
							...
							<div class="form-group formio-component-textarea">
								<textarea type="text" name="description" maxlength="100"
									class="form-conrol" id="inp_desc"></textarea>
							</div>
						</aui:col>
					</aui:row>
					...
					<aui:row>
						<aui:col span="12" cssClass="userAction">
							<button type="button" onclick="validateHoliday('Draft')"
								id="draft" style="display: none" class="btn btn-default">SAVE
								DRAFT</button>
							...
							<button type="button" onclick="validateHoliday('Active')"
								class="btn btn-primary" id="save" style="display: none">SAVE</button>
							<button type="button" class="btn btn-warning btn-md btn-deactive" id="deactivate"
								style="display: none" onClick="DeactivationPopUp()">Deactivate</button>
							...
							<button type="button" onclick="reset();" class="btn btn-default"
								id="clear" style="display: none">CLEAR</button>
						</aui:col>
			...
			ajaxCallAPI('GET','searchList',data1,
				 function() {
	                ...
	                if (_.isEmpty(response)) {
	                	...
	                	}else if(response.numberOfElements == 1 && response.content[0].storageId != formStorageId){
