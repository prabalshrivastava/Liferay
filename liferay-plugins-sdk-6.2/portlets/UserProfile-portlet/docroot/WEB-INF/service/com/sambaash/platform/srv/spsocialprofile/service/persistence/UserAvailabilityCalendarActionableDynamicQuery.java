 ...
 * @generated
 */
public abstract class UserAvailabilityCalendarActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public UserAvailabilityCalendarActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(UserAvailabilityCalendarLocalServiceUtil.getService());
		setClass(UserAvailabilityCalendar.class);

		setClassLoader(com.sambaash.platform.srv.spsocialprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("userAvailabilityCalendarId");
	}
}