 ...
 * @generated
 */
public abstract class FundingRoundActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public FundingRoundActionableDynamicQuery() throws SystemException {
		setBaseLocalService(FundingRoundLocalServiceUtil.getService());
		setClass(FundingRound.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("fundingRoundId");
	}
}