 ...
 * @generated
 */
public abstract class QuestionnaireActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public QuestionnaireActionableDynamicQuery() throws SystemException {
		setBaseLocalService(QuestionnaireLocalServiceUtil.getService());
		setClass(Questionnaire.class);

		setClassLoader(com.sambaash.platform.srv.startupprofile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("questionnaireId");
	}
}