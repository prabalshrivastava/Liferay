...
/**
 * The persistence utility for the g u upload log service. This utility wraps {@link GUUploadLogPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class GUUploadLogUtil {
	 ...
	 */
	public static void clearCache(GUUploadLog guUploadLog) {
		getPersistence().clearCache(guUploadLog);
	}
	 ...
	 */
	public static List<GUUploadLog> findWithDynamicQuery(
	 ...
	 */
	public static GUUploadLog update(GUUploadLog guUploadLog)
		throws SystemException {
		return getPersistence().update(guUploadLog);
	}
	...
	public static GUUploadLog update(GUUploadLog guUploadLog,
		...
		return getPersistence().update(guUploadLog, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(guUploadLog);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(guUploadLogs);
	}
	...
	*/
	public static com.sambaash.platform.srv.genericuploader.model.GUUploadLog create(
		...
		return getPersistence().create(SPGUUploadLogId);
	}
	...
	*/
	public static com.sambaash.platform.srv.genericuploader.model.GUUploadLog remove(
		long SPGUUploadLogId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.genericuploader.NoSuchGUUploadLogException {
		return getPersistence().remove(SPGUUploadLogId);
	}

	public static com.sambaash.platform.srv.genericuploader.model.GUUploadLog updateImpl(
		com.sambaash.platform.srv.genericuploader.model.GUUploadLog guUploadLog)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(guUploadLog);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.genericuploader.model.GUUploadLog findByPrimaryKey(
		long SPGUUploadLogId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.genericuploader.NoSuchGUUploadLogException {
		return getPersistence().findByPrimaryKey(SPGUUploadLogId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.genericuploader.model.GUUploadLog fetchByPrimaryKey(
		long SPGUUploadLogId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(SPGUUploadLogId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.genericuploader.model.GUUploadLog> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static GUUploadLogPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (GUUploadLogPersistence)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.genericuploader.service.ClpSerializer.getServletContextName(),
					GUUploadLogPersistence.class.getName());

			ReferenceRegistry.registerReference(GUUploadLogUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(GUUploadLogPersistence persistence) {
	}

	private static GUUploadLogPersistence _persistence;
}