...
/**
 * Provides the local service interface for MembershipSubscriptionAddonServices. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see MembershipSubscriptionAddonServicesLocalServiceUtil
...
public interface MembershipSubscriptionAddonServicesLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MembershipSubscriptionAddonServicesLocalServiceUtil} to access the membership subscription addon services local service. Add custom service methods to {@link com.sambaash.platform.srv.spservices.service.impl.MembershipSubscriptionAddonServicesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
