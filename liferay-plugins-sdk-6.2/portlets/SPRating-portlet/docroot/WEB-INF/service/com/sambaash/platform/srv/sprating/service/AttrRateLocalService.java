...
/**
 * Provides the local service interface for AttrRate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author harini
 * @see AttrRateLocalServiceUtil
...
public interface AttrRateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AttrRateLocalServiceUtil} to access the attr rate local service. Add custom service methods to {@link com.sambaash.platform.srv.sprating.service.impl.AttrRateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
