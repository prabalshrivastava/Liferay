 ...
 * @generated
 */
public abstract class SPSellingPackageActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPSellingPackageActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPSellingPackageLocalServiceUtil.getService());
		setClass(SPSellingPackage.class);

		setClassLoader(com.sambaash.platform.srv.spshopping.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spSellingPackageId");
	}
}