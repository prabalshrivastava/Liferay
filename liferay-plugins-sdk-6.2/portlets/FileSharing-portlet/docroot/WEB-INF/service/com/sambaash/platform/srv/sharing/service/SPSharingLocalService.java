...
/**
 * Provides the local service interface for SPSharing. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author harini
 * @see SPSharingLocalServiceUtil
...
public interface SPSharingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPSharingLocalServiceUtil} to access the s p sharing local service. Add custom service methods to {@link com.sambaash.platform.srv.sharing.service.impl.SPSharingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
