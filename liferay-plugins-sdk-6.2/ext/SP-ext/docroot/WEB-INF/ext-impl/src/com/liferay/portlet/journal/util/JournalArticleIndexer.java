...
public class JournalArticleIndexer extends BaseIndexer {
	...
	protected Document doGetDocument(Object obj) throws Exception {
		...
		String title1Key = "ddm/"+document.get("classTypeId")+"/Title1_"+document.get("defaultLanguageId");
		document.addText("title1", document.get(title1Key));
		
		String infoNumberKey = "ddm/"+document.get("classTypeId")+"/InfoNumber_"+document.get("defaultLanguageId");
		document.addText("infoNumber", document.get(infoNumberKey));
		
		String thumbnailImageKey = "ddm/"+document.get("classTypeId")+"/minisite_thumbnailImage_"+document.get("defaultLanguageId"); 
		document.addText("minisite_thumbnailImage", document.get(thumbnailImageKey));
		
		String orgLogoKey = "ddm/"+document.get("classTypeId")+"/minisite_OrgLogo_"+document.get("defaultLanguageId");
		document.addText("minisite_OrgLogo", document.get(orgLogoKey));
		
		String listingTitleKey = "ddm/"+document.get("classTypeId")+"/minisite_listingTitle_"+document.get("defaultLanguageId");
		document.addText("minisite_listingTitle", document.get(listingTitleKey));
		document.addText(LISTING_TITLE_LOWER, getSearchableString(document.get(listingTitleKey)));
		
		String createdDateKey = "ddm/"+document.get("classTypeId")+"/minisite_createdDate_"+document.get("defaultLanguageId");
		document.addText("minisite_createdDate", document.get(createdDateKey));
		
		String listingDescriptionKey = "ddm/"+document.get("classTypeId")+"/minisite_listingDescription_"+document.get("defaultLanguageId");
		document.addText("minisite_listingDescription", document.get(listingDescriptionKey));
		
		String pageUrlKey = "ddm/"+document.get("classTypeId")+"/minisite_pageUrl_"+document.get("defaultLanguageId");
		document.addText("minisite_pageUrl", document.get(pageUrlKey));
		...
		if (latestIndexableArticle.getVersion() == article.getVersion() && latestIndexableArticle.getResourcePrimKey() == article.getResourcePrimKey()){
			document.addText(LATEST_VERSION, "1");
		}else{
			document.addText(LATEST_VERSION, "0");
		}
	...
	protected Collection<Document> getArticleVersions(JournalArticle article)
		...
		for (JournalArticle curArticle : articles) {
			...
			try{
				...
				_log.error("Failed to check article version " + curArticle.toString());
			}
		}
		...
		ActionableDynamicQuery actionableDynamicQuery =
			...
			protected void performAction(Object object) throws PortalException {
				...
				try {
					...
					_log.error("Failed to reindex article : " + article.toString());
				}
			}
	...
	public static final String CATEGORIZATION = Field.ASSET_CATEGORY_TITLES;
	public static final String CATEGORIZATION_IDS = Field.ASSET_CATEGORY_IDS;
	public static final String TAG_NAME = Field.ASSET_TAG_NAMES;
	public static final String TAG_IDS = Field.ASSET_TAG_IDS;
	public static final String ARTICLE_ID = "articleId";
	public static final String TITLE = Field.TITLE;
	public static final String DESCRIPTION = Field.DESCRIPTION;
	public static final String LATEST_VERSION = "latestVersion";
	public static final String LISTING_TITLE_LOWER = "listingTitleLower";

	
	public Map<String, String> getIndexedFields() {
		Map<String, String> map = new HashMap<String, String>(super.getIndexedFields());
		map.put(CATEGORIZATION, "Categorization");
		map.put(CATEGORIZATION_IDS, "Categorization Id");
		map.put(TAG_NAME, "Tag Name");
		map.put(TAG_IDS, "Tag Id");
		map.put(ARTICLE_ID, "WebContent Id");
		map.put(TITLE, "Title");
		map.put(DESCRIPTION, "Description");
		map.put(LATEST_VERSION, "Latest Version");
		map.put(LISTING_TITLE_LOWER, "Listing Title Lower");
