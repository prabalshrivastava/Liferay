...
/**
 * Provides the local service interface for SPContactUs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see SPContactUsLocalServiceUtil
...
public interface SPContactUsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPContactUsLocalServiceUtil} to access the s p contact us local service. Add custom service methods to {@link com.sambaash.platform.srv.contactus.service.impl.SPContactUsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
