...
/**
 * Provides the local service interface for PersonaAttendee. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see PersonaAttendeeLocalServiceUtil
...
public interface PersonaAttendeeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PersonaAttendeeLocalServiceUtil} to access the persona attendee local service. Add custom service methods to {@link com.sambaash.platform.srv.service.impl.PersonaAttendeeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
