				...
				<aui:row>
					<aui:col span="10" cssClass="offset1">
							...
							<aui:col span="6" cssClass="formio-component-textfield">
								<div class="form-group">
									...
									<aui:input type="text" name="" id="noOfRows"
										cssClass="form-control" onkeyup="checkDigitis(this,12);" onkeypress="preventOtherCharacters(event)" >
									</aui:input>
								</div>
							</aui:col>
							<aui:col span="6" cssClass="formio-component-textfield">
						...
						<aui:row cssClass="userAction">
							<aui:col span="12">
								<center>
									<button type="button" class="btn btn-success btn-md" id="deactivate"
										onClick="storageStatus1('Inactive','<%=formStorageId %>')" style="background-color: #ffc48b !important; color: #703802 !important; display:none">DEACTIVATE</button>
									<button type="button" class="btn btn-success btn-md" id="activate"
										onClick="storageStatus1('Active','<%=formStorageId %>')" style="background-color: #5cb85c !important; color: white !important; display:none">REACTIVATE</button>
								&nbsp;
