...
import com.sambaash.platform.srv.spshopping.service.SPShoppingLocalService;
...
/**
 * Provides the base implementation for the s p shopping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sambaash.platform.srv.spshopping.service.impl.SPShoppingLocalServiceImpl}.
 * </p>
 *
 * @author pradeep
 ...
 * @generated
 */
public abstract class SPShoppingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SPShoppingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sambaash.platform.srv.spshopping.service.SPShoppingLocalServiceUtil} to access the s p shopping local service.
	 */
	...
	private SPShoppingLocalServiceClpInvoker _clpInvoker = new SPShoppingLocalServiceClpInvoker();
}