...
/**
 * Provides the local service interface for ConfigurationProperty. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author liferay
 * @see ConfigurationPropertyLocalServiceUtil
...
public interface ConfigurationPropertyLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ConfigurationPropertyLocalServiceUtil} to access the configuration property local service. Add custom service methods to {@link com.wtberks.configuration.service.impl.ConfigurationPropertyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
