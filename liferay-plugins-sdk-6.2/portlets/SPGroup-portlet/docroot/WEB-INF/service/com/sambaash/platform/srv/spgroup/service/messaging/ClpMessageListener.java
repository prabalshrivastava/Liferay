...
package com.sambaash.platform.srv.spgroup.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SPGroupLocalServiceUtil.clearService();

			SPGroupPrefLocalServiceUtil.clearService();

			SPGroupUserLocalServiceUtil.clearService();
		}
	}
}