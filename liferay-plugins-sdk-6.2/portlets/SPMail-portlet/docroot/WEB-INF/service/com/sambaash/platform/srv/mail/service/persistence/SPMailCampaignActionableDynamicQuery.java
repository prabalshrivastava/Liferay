 ...
 * @generated
 */
public abstract class SPMailCampaignActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPMailCampaignActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPMailCampaignLocalServiceUtil.getService());
		setClass(SPMailCampaign.class);

		setClassLoader(com.sambaash.platform.srv.mail.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spMailCampaignId");
	}
}