 ...
 * @generated
 */
public abstract class MembershipSubscriptionActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MembershipSubscriptionActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(MembershipSubscriptionLocalServiceUtil.getService());
		setClass(MembershipSubscription.class);

		setClassLoader(com.sambaash.platform.srv.spservices.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("msId");
	}
}