	...
	function(A) {
		...
		Panel.prototype = {
			...
			_createPanel: function(fromMarkup) {
				...
				if (instance._textBox != null) {
					instance._textBox.setStyle("resize", "none");
					instance._textBox.setAttribute("maxlength", 200);
				}
					...
					var html = '<li class="user user_' + instance._panelId + '" panelId="' + instance._panelId + '">' +
									...
									'<div class="chat-panel">' +
										'<div class="panel-window">' +
											...
											'<img alt="User Image" class="panel-icon" src="' + userImagePath + '" />' +
		...
		Liferay.Chat.Manager = {
			init: function() {
				...
				instance._sound = new SWFObject('/SPChat-portlet/alert.swf', 'alertsound', '0', '0', '8');
			...
			_createSettingsPanel: function() {
				...
				instance._statusMessageObj.setAttribute("maxlength", "70");
				...
				for (var i = 0; i < numBuddies; i++) {
					...
					buffer.push(
						'<li class="active user" data-groupId="' + buddy.groupId + '" data-userId="' + buddy.userId + '">' +
							'<img alt="User Image" src="' + userImagePath + '" />' +
