 ...
 * @generated
 */
public abstract class SPGroupPrefActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SPGroupPrefActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SPGroupPrefLocalServiceUtil.getService());
		setClass(SPGroupPref.class);

		setClassLoader(com.sambaash.platform.srv.spgroup.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spGroupPrefId");
	}
}