package com.sambaash.platform.candidatelist;
...
/**
 * Portlet implementation class CandidateListPortlet
 */
public class CandidateListPortlet extends MVCPortlet {
     ...
     */
    private Log log = LogFactoryUtil.getLog(CandidateListPortlet.class.getName());
