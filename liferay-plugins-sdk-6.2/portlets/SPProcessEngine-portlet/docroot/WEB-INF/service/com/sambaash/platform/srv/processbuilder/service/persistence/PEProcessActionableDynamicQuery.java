 ...
 * @generated
 */
public abstract class PEProcessActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PEProcessActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PEProcessLocalServiceUtil.getService());
		setClass(PEProcess.class);

		setClassLoader(com.sambaash.platform.srv.processbuilder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPEProcessId");
	}
}