 ...
 * @generated
 */
public class SPRPECServiceClp implements SPRPECService {
	public SPRPECServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "updateStatusNotification";
	...
	public void updateStatusNotification(java.lang.String candidateEmail,
		...
		try {
			_invokableService.invokeMethod(_methodName3,
				...
				new Object[] {
					ClpSerializer.translateInput(candidateEmail),
					
				ClpSerializer.translateInput(firstName),
					
				ClpSerializer.translateInput(lastName),
					
				ClpSerializer.translateInput(rpecStatus),
					
				ClpSerializer.translateInput(updateBy),
					
				ClpSerializer.translateInput(dateOfUpdation),
					
				ClpSerializer.translateInput(mentorId),
					
				ClpSerializer.translateInput(trainingPricipalId)
				});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
