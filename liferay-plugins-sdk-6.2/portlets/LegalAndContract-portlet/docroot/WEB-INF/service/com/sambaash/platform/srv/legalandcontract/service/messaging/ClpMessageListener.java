...
package com.sambaash.platform.srv.legalandcontract.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ClassMasterLocalServiceUtil.clearService();

			LitigationLocalServiceUtil.clearService();

			RDLLocalServiceUtil.clearService();

			TrademarksLocalServiceUtil.clearService();
		}
	}
}