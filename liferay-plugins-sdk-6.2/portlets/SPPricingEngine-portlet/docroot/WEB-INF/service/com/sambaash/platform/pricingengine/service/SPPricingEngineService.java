...
/**
 * Provides the remote service interface for SPPricingEngine. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author bhavin.panchani
 * @see SPPricingEngineServiceUtil
...
public interface SPPricingEngineService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPPricingEngineServiceUtil} to access the s p pricing engine remote service. Add custom service methods to {@link com.sambaash.platform.pricingengine.service.impl.SPPricingEngineServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
