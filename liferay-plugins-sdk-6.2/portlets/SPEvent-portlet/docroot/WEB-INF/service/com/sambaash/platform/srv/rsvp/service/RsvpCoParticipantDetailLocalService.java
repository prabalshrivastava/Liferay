...
/**
 * Provides the local service interface for RsvpCoParticipantDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see RsvpCoParticipantDetailLocalServiceUtil
...
public interface RsvpCoParticipantDetailLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RsvpCoParticipantDetailLocalServiceUtil} to access the rsvp co participant detail local service. Add custom service methods to {@link com.sambaash.platform.srv.rsvp.service.impl.RsvpCoParticipantDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
