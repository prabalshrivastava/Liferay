...
/**
 * Provides the local service interface for SPProctorRostorReport. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gaurav.kapadiya
 * @see SPProctorRostorReportLocalServiceUtil
...
public interface SPProctorRostorReportLocalService extends BaseLocalService,
	InvokableLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPProctorRostorReportLocalServiceUtil} to access the s p proctor rostor report local service. Add custom service methods to {@link com.sambaash.platform.proctorrostor.service.impl.SPProctorRostorReportLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
