 ...
 * @generated
 */
public class MembershipPackageGrpServicesSoap implements Serializable {
	public static MembershipPackageGrpServicesSoap toSoapModel(
		MembershipPackageGrpServices model) {
		MembershipPackageGrpServicesSoap soapModel = new MembershipPackageGrpServicesSoap();
	...
	public static MembershipPackageGrpServicesSoap[] toSoapModels(
		MembershipPackageGrpServices[] models) {
		MembershipPackageGrpServicesSoap[] soapModels = new MembershipPackageGrpServicesSoap[models.length];
	...
	public static MembershipPackageGrpServicesSoap[][] toSoapModels(
		MembershipPackageGrpServices[][] models) {
		MembershipPackageGrpServicesSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new MembershipPackageGrpServicesSoap[models.length][models[0].length];
		}
		else {
			soapModels = new MembershipPackageGrpServicesSoap[0][0];
		}
	...
	public static MembershipPackageGrpServicesSoap[] toSoapModels(
		List<MembershipPackageGrpServices> models) {
		List<MembershipPackageGrpServicesSoap> soapModels = new ArrayList<MembershipPackageGrpServicesSoap>(models.size());

		for (MembershipPackageGrpServices model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new MembershipPackageGrpServicesSoap[soapModels.size()]);
	}

	public MembershipPackageGrpServicesSoap() {
	}
