...
/**
 * Provides the local service interface for EnrollBatchUpload. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Baxture
 * @see EnrollBatchUploadLocalServiceUtil
...
public interface EnrollBatchUploadLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EnrollBatchUploadLocalServiceUtil} to access the enroll batch upload local service. Add custom service methods to {@link com.sambaash.platform.srv.enrolment.service.impl.EnrollBatchUploadLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
