 ...
 * @generated
 */
public abstract class RsvpTicketActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RsvpTicketActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RsvpTicketLocalServiceUtil.getService());
		setClass(RsvpTicket.class);

		setClassLoader(com.sambaash.platform.srv.rsvp.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("rsvpTicketId");
	}
}