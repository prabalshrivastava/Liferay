 ...
 * @generated
 */
public abstract class PERuleActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PERuleActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PERuleLocalServiceUtil.getService());
		setClass(PERule.class);

		setClassLoader(com.sambaash.platform.srv.processbuilder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("spPERuleId");
	}
}