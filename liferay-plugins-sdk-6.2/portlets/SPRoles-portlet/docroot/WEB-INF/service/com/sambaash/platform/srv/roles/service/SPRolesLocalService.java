...
/**
 * Provides the local service interface for SPRoles. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gauravvijayvergia
 * @see SPRolesLocalServiceUtil
...
public interface SPRolesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPRolesLocalServiceUtil} to access the s p roles local service. Add custom service methods to {@link com.sambaash.platform.srv.roles.service.impl.SPRolesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
