...
/**
 * The persistence utility for the duration type service. This utility wraps {@link DurationTypePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class DurationTypeUtil {
	 ...
	 */
	public static void clearCache(DurationType durationType) {
		getPersistence().clearCache(durationType);
	}
	 ...
	 */
	public static List<DurationType> findWithDynamicQuery(
	 ...
	 */
	public static DurationType update(DurationType durationType)
		throws SystemException {
		return getPersistence().update(durationType);
	}
	...
	public static DurationType update(DurationType durationType,
		...
		return getPersistence().update(durationType, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(durationType);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(durationTypes);
	}
	...
	*/
	public static com.sambaash.platform.srv.model.DurationType create(
		long spDurationTypeId) {
		return getPersistence().create(spDurationTypeId);
	}
	...
	*/
	public static com.sambaash.platform.srv.model.DurationType remove(
		long spDurationTypeId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.NoSuchDurationTypeException {
		return getPersistence().remove(spDurationTypeId);
	}

	public static com.sambaash.platform.srv.model.DurationType updateImpl(
		com.sambaash.platform.srv.model.DurationType durationType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(durationType);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.DurationType findByPrimaryKey(
		long spDurationTypeId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sambaash.platform.srv.NoSuchDurationTypeException {
		return getPersistence().findByPrimaryKey(spDurationTypeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sambaash.platform.srv.model.DurationType fetchByPrimaryKey(
		long spDurationTypeId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(spDurationTypeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sambaash.platform.srv.model.DurationType> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static DurationTypePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (DurationTypePersistence)PortletBeanLocatorUtil.locate(com.sambaash.platform.srv.service.ClpSerializer.getServletContextName(),
					DurationTypePersistence.class.getName());

			ReferenceRegistry.registerReference(DurationTypeUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(DurationTypePersistence persistence) {
	}

	private static DurationTypePersistence _persistence;
}