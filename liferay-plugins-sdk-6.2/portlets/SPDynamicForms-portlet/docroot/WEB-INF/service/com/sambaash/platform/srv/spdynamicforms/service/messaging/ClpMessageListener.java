...
package com.sambaash.platform.srv.spdynamicforms.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SPDynamicFormsLocalServiceUtil.clearService();

			SPDynamicFormsServiceUtil.clearService();
			SPFormAttachmentsLocalServiceUtil.clearService();

			SPFormStorageLocalServiceUtil.clearService();
		}
	}
}