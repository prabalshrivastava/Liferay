...
/**
 * Provides the local service interface for SPPaymentCustomer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pradeep
 * @see SPPaymentCustomerLocalServiceUtil
...
public interface SPPaymentCustomerLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPPaymentCustomerLocalServiceUtil} to access the s p payment customer local service. Add custom service methods to {@link com.sambaash.platform.srv.sppayment.service.impl.SPPaymentCustomerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
