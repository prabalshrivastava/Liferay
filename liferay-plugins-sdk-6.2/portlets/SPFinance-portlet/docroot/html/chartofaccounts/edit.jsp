...
function afterFormDataLoadedFormIOForm(thisInstance){
	if(thisInstance.components.FormStat.element.innerText!="Draft") {
		...
		thisInstance.components["GlCodeType"].disabled = true;
		thisInstance.components["AccountType"].disabled = true;
	}
	if(thisInstance.form.submission.data.GlCodeType=="Control") {
		thisInstance.components["ChartOfAccount"].disabled = true;
	} else {
		thisInstance.components["ChartOfAccount"].disabled = false;
	}
