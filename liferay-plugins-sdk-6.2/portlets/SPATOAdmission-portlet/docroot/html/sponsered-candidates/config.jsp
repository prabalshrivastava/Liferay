...
<%
	...
	String secondaryContact = renderRequest.getPreferences().getValue("secondaryContact","");
...
<aui:row cssClass="ps-pref-container" style="margin:10px auto; max-width:640px">
	<aui:col span="12">
		<aui:form name="editPreferences" action="<%=savePreferencesActionURL%>">			
			...
			<aui:input name="secondaryContact" label="Secondary Contact" value='<%=secondaryContact%>'></aui:input>
