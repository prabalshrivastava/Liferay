...
public class DLFileEntryIndexer extends BaseIndexer {
	...
	protected Document doGetDocument(Object obj) throws Exception {
		// Naresh : March ,8th 2016: try/catch added over complete code.
		DLFileEntry dlFileEntry = (DLFileEntry)obj;
		...
		try{
			...
			try {
				...
				// Naresh 11-Nov-2014 Added version for indexing
				document.addKeyword("version", dlFileEntry.getVersion());
