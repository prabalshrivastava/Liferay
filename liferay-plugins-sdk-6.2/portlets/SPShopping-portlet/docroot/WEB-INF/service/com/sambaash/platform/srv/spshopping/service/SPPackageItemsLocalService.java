...
/**
 * Provides the local service interface for SPPackageItems. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pradeep
 * @see SPPackageItemsLocalServiceUtil
...
public interface SPPackageItemsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SPPackageItemsLocalServiceUtil} to access the s p package items local service. Add custom service methods to {@link com.sambaash.platform.srv.spshopping.service.impl.SPPackageItemsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
