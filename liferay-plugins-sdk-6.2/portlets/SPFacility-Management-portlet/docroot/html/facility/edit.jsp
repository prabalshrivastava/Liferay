				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="row userAction">
							...
							<div class="col-sm-12 text-center">
								<button type="button" class="btn btn-default" style="display:none" id="btn-draft"
										onclick="saveDraftFields()">SAVE DRAFT</button>
								<button type="button" class="btn btn-primary" id="publish"
									onclick="validateFields(this)">UPDATE</button>
								<button type="button" class="btn btn-reactive"
									style="display: none" onclick="Active()" id="reactive">REACTIVATE</button>
								<button type="button" class="btn btn-deactive" id="deactive"
									style="display: none" onclick="Deactive()">DEACTIVATE</button>

								<button type="button" class="btn btn-default" onclick="reset(this);">CLEAR</button>
