...
/**
 * Provides the local service interface for IBMessageDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nareshchebolu
 * @see IBMessageDetailLocalServiceUtil
...
public interface IBMessageDetailLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IBMessageDetailLocalServiceUtil} to access the i b message detail local service. Add custom service methods to {@link com.sambaash.platform.srv.spinbox.service.impl.IBMessageDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
